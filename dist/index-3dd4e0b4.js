...
var fh = { exports: {} }, Ro = {}, Sa = { exports: {} }, ae = {};
/**
 * @license React
...
var mf;
function tu() {
  return mf || (mf = 1, Sa.exports = Vg()), Sa.exports;
}
/**
 * @license React
...
function Kg() {
  if (gf)
    return Ro;
  gf = 1;
  var i = tu(), n = Symbol.for("react.element"), r = Symbol.for("react.fragment"), s = Object.prototype.hasOwnProperty, a = i.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, u = { key: !0, ref: !0, __self: !0, __source: !0 };
  function f(h, p, g) {
...
fh.exports = Kg();
var W = fh.exports, Fa = {}, hh = { exports: {} }, ot = {}, ba = { exports: {} }, Ea = {};
/**
 * @license React
...
var yf;
function Qg() {
  return yf || (yf = 1, ba.exports = Gg()), ba.exports;
}
/**
 * @license React
...
` + c[m].replace(" at new ", " at ");
  ...
  function Ou(e, t) {
    ...
    for (var o in t)
      if (t.hasOwnProperty(o)) {
        var l = o.indexOf("--") === 0, c = Tu(o, t[o], l);
        o === "float" && (o = "cssFloat"), l ? e.setProperty(o, c) : e[o] = c;
      }
  }
  var Qp = V({ menuitem: !0 }, { area: !0, base: !0, br: !0, col: !0, embed: !0, hr: !0, img: !0, input: !0, keygen: !0, link: !0, meta: !0, param: !0, source: !0, track: !0, wbr: !0 });
  function Is(e, t) {
    if (t) {
  ...
  var qr = !1, Qo = null, qo = !1, Bs = null, Jp = { onError: function(e) {
    qr = !0, Qo = e;
  } };
  function Yp(e, t, o, l, c, d, m, w, x) {
    qr = !1, Qo = null, qp.apply(Jp, arguments);
  }
  function Xp(e, t, o, l, c, d, m, w, x) {
    if (Yp.apply(this, arguments), qr) {
      if (qr) {
        var R = Qo;
        qr = !1, Qo = null;
      } else
  ...
  function zu(e) {
    return e = Zp(e), e !== null ? Mu(e) : null;
  }
  function Mu(e) {
    if (e.tag === 5 || e.tag === 6)
      return e;
  ...
  var Fu = n.unstable_scheduleCallback, Uu = n.unstable_cancelCallback, em = n.unstable_shouldYield, tm = n.unstable_requestPaint, Ie = n.unstable_now, nm = n.unstable_getCurrentPriorityLevel, Ws = n.unstable_ImmediatePriority, Bu = n.unstable_UserBlockingPriority, Jo = n.unstable_NormalPriority, rm = n.unstable_LowPriority, Wu = n.unstable_IdlePriority, Yo = null, jt = null;
  function om(e) {
  ...
  var xt = Math.clz32 ? Math.clz32 : lm, im = Math.log, sm = Math.LN2;
  function lm(e) {
  ...
  function um(e, t) {
    for (var o = e.suspendedLanes, l = e.pingedLanes, c = e.expirationTimes, d = e.pendingLanes; 0 < d; ) {
      ...
      x === -1 ? (!(w & o) || w & l) && (c[m] = am(w, t)) : x <= t && (e.expiredLanes |= w), d &= ~w;
    }
  }
  function Hs(e) {
  ...
  var Ku, Gs, Gu, Qu, qu, Qs = !1, ti = [], en = null, tn = null, nn = null, Xr = /* @__PURE__ */ new Map(), Zr = /* @__PURE__ */ new Map(), rn = [], dm = "mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput copy cut paste click change contextmenu reset submit".split(" ");
  function Ju(e, t) {
    switch (e) {
      case "focusin":
      case "focusout":
  ...
  function hm() {
    Qs = !1, en !== null && ni(en) && (en = null), tn !== null && ni(tn) && (tn = null), nn !== null && ni(nn) && (nn = null), Xr.forEach(Xu), Zr.forEach(Xu);
  }
  function to(e, t) {
    e.blockedOn === t && (e.blockedOn = null, Qs || (Qs = !0, n.unstable_scheduleCallback(n.unstable_NormalPriority, hm)));
  }
  function no(e) {
    function t(c) {
      return to(c, e);
    ...
    for (; 0 < rn.length && (o = rn[0], o.blockedOn === null); )
      Yu(o), o.blockedOn === null && rn.shift();
  }
  ...
  function qs(e, t, o, l) {
    if (ri) {
      var c = Js(e, t, o, l);
      if (c === null)
        hl(e, t, l, oi, o), Ju(e, l);
      else if (fm(c, e, t, o, l))
        l.stopPropagation();
      else if (Ju(e, l), t & 4 && -1 < dm.indexOf(e)) {
        for (; c !== null; ) {
          var d = mo(c);
          if (d !== null && Ku(d), d = Js(e, t, o, l), d === null && hl(e, t, l, oi, o), d === c)
            break;
          c = d;
        }
  ...
  function it(e) {
    function t(o, l, c, d, m) {
      ...
      return this.isDefaultPrevented = (d.defaultPrevented != null ? d.defaultPrevented : d.returnValue === !1) ? li : tc, this.isPropagationStopped = tc, this;
    }
  ...
  }, defaultPrevented: 0, isTrusted: 0 }, Xs = it(ir), ro = V({}, ir, { view: 0, detail: 0 }), gm = it(ro), Zs, el, oo, ai = V({}, ro, { screenX: 0, screenY: 0, clientX: 0, clientY: 0, pageX: 0, pageY: 0, ctrlKey: 0, shiftKey: 0, altKey: 0, metaKey: 0, getModifierState: nl, button: 0, buttons: 0, relatedTarget: function(e) {
  ...
  } }), nc = it(ai), vm = V({}, ai, { dataTransfer: 0 }), ym = it(vm), wm = V({}, ro, { relatedTarget: 0 }), tl = it(wm), _m = V({}, ir, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }), xm = it(_m), km = V({}, ir, { clipboardData: function(e) {
    return "clipboardData" in e ? e.clipboardData : window.clipboardData;
  } }), Sm = it(km), bm = V({}, ir, { data: 0 }), rc = it(bm), Em = {
    Esc: "Escape",
    Spacebar: " ",
    Left: "ArrowLeft",
    Up: "ArrowUp",
  ...
  var Om = V({}, ro, { key: function(e) {
  ...
  } }), Rm = it(Om), Am = V({}, ai, { pointerId: 0, width: 0, height: 0, pressure: 0, tangentialPressure: 0, tiltX: 0, tiltY: 0, twist: 0, pointerType: 0, isPrimary: 0 }), oc = it(Am), jm = V({}, ro, { touches: 0, targetTouches: 0, changedTouches: 0, altKey: 0, metaKey: 0, ctrlKey: 0, shiftKey: 0, getModifierState: nl }), Nm = it(jm), Lm = V({}, ir, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }), Im = it(Lm), $m = V({}, ai, {
    deltaX: function(e) {
    ...
    deltaZ: 0,
    deltaMode: 0
  }), Dm = it($m), zm = [9, 13, 27, 32], rl = h && "CompositionEvent" in window, io = null;
  h && "documentMode" in document && (io = document.documentMode);
  var Mm = h && "TextEvent" in window && !io, ic = h && (!rl || io && 8 < io && 11 >= io), sc = String.fromCharCode(32), lc = !1;
  function ac(e, t) {
    switch (e) {
      case "keyup":
  ...
  function Um(e, t) {
    if (sr)
      return e === "compositionend" || !rl && ac(e, t) ? (e = ec(), ii = Ys = on = null, sr = !1, e) : null;
    switch (e) {
      case "paste":
        return null;
      case "keypress":
  ...
  function dc(e, t, o, l) {
    Au(l), t = hi(t, "onChange"), 0 < t.length && (o = new Xs("onChange", "change", null, o, l), e.push({ event: o, listeners: t }));
  }
  var so = null, lo = null;
  function Wm(e) {
    Oc(e, 0);
  ...
  if (h) {
    ...
    if (h) {
      ...
      if (!il) {
        ...
        hc.setAttribute("oninput", "return;"), il = typeof hc.oninput == "function";
      }
      ol = il;
    } else
      ol = !1;
    fc = ol && (!document.documentMode || 9 < document.documentMode);
  }
  function pc() {
    so && (so.detachEvent("onpropertychange", mc), lo = so = null);
  }
  function mc(e) {
    if (e.propertyName === "value" && ui(lo)) {
      var t = [];
      dc(t, lo, e, zs(e)), Iu(Wm, t);
    }
  }
  function Vm(e, t, o) {
    e === "focusin" ? (pc(), so = t, lo = o, so.attachEvent("onpropertychange", mc)) : e === "focusout" && pc();
  }
  function Km(e) {
  ...
  var kt = typeof Object.is == "function" ? Object.is : qm;
  function ao(e, t) {
    if (kt(e, t))
      return !0;
  ...
  function Jm(e) {
    var t = wc(), o = e.focusedElem, l = e.selectionRange;
    if (t !== o && o && o.ownerDocument && yc(o.ownerDocument.documentElement, o)) {
      if (l !== null && sl(o)) {
        if (t = l.start, e = l.end, e === void 0 && (e = t), "selectionStart" in o)
          ...
          l = l.end === void 0 ? d : Math.min(l.end, c), !e.extend && d > l && (c = l, l = d, d = c), c = vc(o, d);
          var m = vc(
            o,
            l
          );
  ...
  var Ym = h && "documentMode" in document && 11 >= document.documentMode, lr = null, ll = null, uo = null, al = !1;
  function _c(e, t, o) {
  ...
  var ar = { animationend: ci("Animation", "AnimationEnd"), animationiteration: ci("Animation", "AnimationIteration"), animationstart: ci("Animation", "AnimationStart"), transitionend: ci("Transition", "TransitionEnd") }, ul = {}, xc = {};
  h && (xc = document.createElement("div").style, "AnimationEvent" in window || (delete ar.animationend.animation, delete ar.animationiteration.animation, delete ar.animationstart.animation), "TransitionEvent" in window || delete ar.transitionend.transition);
  function di(e) {
    if (ul[e])
      return ul[e];
    if (!ar[e])
    ...
    var t = ar[e], o;
    for (o in t)
      if (t.hasOwnProperty(o) && o in xc)
        return ul[e] = t[o];
    return e;
  }
  var kc = di("animationend"), Sc = di("animationiteration"), bc = di("animationstart"), Ec = di("transitionend"), Cc = /* @__PURE__ */ new Map(), Pc = "abort auxClick cancel canPlay canPlayThrough click close contextMenu copy cut drag dragEnd dragEnter dragExit dragLeave dragOver dragStart drop durationChange emptied encrypted ended error gotPointerCapture input invalid keyDown keyPress keyUp load loadedData loadedMetadata loadStart lostPointerCapture mouseDown mouseMove mouseOut mouseOver mouseUp paste pause play playing pointerCancel pointerDown pointerMove pointerOut pointerOver pointerUp progress rateChange reset resize seeked seeking stalled submit suspend timeUpdate touchCancel touchEnd touchStart volumeChange scroll toggle touchMove waiting wheel".split(" ");
  function sn(e, t) {
    Cc.set(e, t), u(t, [e]);
  }
  for (var cl = 0; cl < Pc.length; cl++) {
    var dl = Pc[cl], Xm = dl.toLowerCase(), Zm = dl[0].toUpperCase() + dl.slice(1);
    sn(Xm, "on" + Zm);
  }
  sn(kc, "onAnimationEnd"), sn(Sc, "onAnimationIteration"), sn(bc, "onAnimationStart"), sn("dblclick", "onDoubleClick"), sn("focusin", "onFocus"), sn("focusout", "onBlur"), sn(Ec, "onTransitionEnd"), f("onMouseEnter", ["mouseout", "mouseover"]), f("onMouseLeave", ["mouseout", "mouseover"]), f("onPointerEnter", ["pointerout", "pointerover"]), f("onPointerLeave", ["pointerout", "pointerover"]), u("onChange", "change click focusin focusout input keydown keyup selectionchange".split(" ")), u("onSelect", "focusout contextmenu dragend focusin keydown keyup mousedown mouseup selectionchange".split(" ")), u("onBeforeInput", ["compositionend", "keypress", "textInput", "paste"]), u("onCompositionEnd", "compositionend focusout keydown keypress keyup mousedown".split(" ")), u("onCompositionStart", "compositionstart focusout keydown keypress keyup mousedown".split(" ")), u("onCompositionUpdate", "compositionupdate focusout keydown keypress keyup mousedown".split(" "));
  var co = "abort canplay canplaythrough durationchange emptied encrypted ended error loadeddata loadedmetadata loadstart pause play playing progress ratechange resize seeked seeking stalled suspend timeupdate volumechange waiting".split(" "), eg = new Set("cancel close invalid load scroll toggle".split(" ").concat(co));
  function Tc(e, t, o) {
    var l = e.type || "unknown-event";
    e.currentTarget = o, Xp(l, t, void 0, e), e.currentTarget = null;
  }
  function Oc(e, t) {
    t = (t & 4) !== 0;
  ...
  function fo(e) {
    if (!e[fi]) {
      e[fi] = !0, s.forEach(function(o) {
        o !== "selectionchange" && (eg.has(o) || fl(o, !1, e), fl(o, !0, e));
      });
      ...
      if (!(t & 7)) {
        e: {
          ...
          if ((K || L) && (L = I.window === I ? I : (L = I.ownerDocument) ? L.defaultView || L.parentWindow : window, K ? (Q = o.relatedTarget || o.toElement, K = R, Q = Q ? Ln(Q) : null, Q !== null && ($e = Nn(Q), Q !== $e || Q.tag !== 5 && Q.tag !== 6) && (Q = null)) : (K = null, Q = R), K !== Q)) {
            if (J = nc, F = "onMouseLeave", T = "onMouseEnter", k = "mouse", (e === "pointerout" || e === "pointerover") && (J = oc, F = "onPointerLeave", T = "onPointerEnter", k = "pointer"), $e = K == null ? L : dr(K), O = Q == null ? L : dr(Q), L = new J(F, k + "leave", K, o, I), L.target = $e, L.relatedTarget = O, F = null, Ln(I) === R && (J = new J(T, k + "enter", Q, o, I), J.target = O, J.relatedTarget = $e, F = J), $e = F, K && Q)
              t: {
              ...
              J = null;
            K !== null && Ac(z, L, K, J, !1), Q !== null && $e !== null && Ac(z, $e, Q, J, !0);
          }
        }
        e: {
          if (L = R ? dr(R) : window, K = L.nodeName && L.nodeName.toLowerCase(), K === "select" || K === "input" && L.type === "file")
            ...
            (K = L.nodeName) && K.toLowerCase() === "input" && (L.type === "checkbox" || L.type === "radio") && (Y = Gm);
          if (Y && (Y = Y(e, R))) {
            dc(z, Y, o, I);
            break e;
          }
        ...
        switch (ee = R ? dr(R) : window, e) {
          case "focusin":
            (cc(ee) || ee.contentEditable === "true") && (lr = ee, ll = R, uo = null);
            break;
          case "focusout":
            uo = ll = lr = null;
            break;
        ...
        if (rl)
          ...
          sr ? ac(e, o) && (re = "onCompositionEnd") : e === "keydown" && o.keyCode === 229 && (re = "onCompositionStart");
        re && (ic && o.locale !== "ko" && (sr || re !== "onCompositionStart" ? re === "onCompositionEnd" && sr && (te = ec()) : (on = I, Ys = "value" in on ? on.value : on.textContent, sr = !0)), ee = hi(R, re), 0 < ee.length && (re = new rc(re, e, null, o, I), z.push({ event: re, listeners: ee }), te ? re.data = te : (te = uc(o), te !== null && (re.data = te)))), (te = Mm ? Fm(e, o) : Um(e, o)) && (R = hi(R, "onBeforeInput"), 0 < R.length && (I = new rc("onBeforeInput", "beforeinput", null, o, I), z.push({ event: I, listeners: R }), I.data = te));
      }
      Oc(z, t);
    });
  }
...
`).replace(ng, "");
  ...
  var vl = typeof setTimeout == "function" ? setTimeout : void 0, rg = typeof clearTimeout == "function" ? clearTimeout : void 0, Nc = typeof Promise == "function" ? Promise : void 0, og = typeof queueMicrotask == "function" ? queueMicrotask : typeof Nc < "u" ? function(e) {
    return Nc.resolve(null).then(e).catch(ig);
  } : vl;
  function ig(e) {
    setTimeout(function() {
      throw e;
  ...
  var cr = Math.random().toString(36).slice(2), Nt = "__reactFiber$" + cr, po = "__reactProps$" + cr, Bt = "__reactContainer$" + cr, wl = "__reactEvents$" + cr, sg = "__reactListeners$" + cr, lg = "__reactHandles$" + cr;
  function Ln(e) {
    var t = e[Nt];
    if (t)
      return t;
  ...
  function Dc(e, t, o) {
    ...
    if (!l)
      throw Error(r(169));
    o ? (e = $c(e, t, In), l.__reactInternalMemoizedMergedChildContext = e, Oe(Ze), Oe(Ve), Ce(Ve, e)) : Oe(Ze), Ce(Ze, o);
  }
  ...
  function cn() {
    if (!xl && Wt !== null) {
      ...
      try {
        ...
        throw Wt !== null && (Wt = Wt.slice(e + 1)), Fu(Ws, cn), c;
      } finally {
        Se = t, xl = !1;
      }
    }
    ...
    if (Ae) {
      ...
      if (t) {
        ...
        if (!Uc(e, t)) {
          ...
          t = ln(o.nextSibling);
          var l = st;
          t && Uc(e, t) ? Fc(l, o) : (e.flags = e.flags & -4097 | 2, Ae = !1, st = e);
        }
      } else {
        if (bl(e))
          throw Error(r(418));
  ...
  function ki(e) {
    ...
    if ((t = e.tag !== 3) && !(t = e.tag !== 5) && (t = e.type, t = t !== "head" && t !== "body" && !gl(e.type, e.memoizedProps)), t && (t = lt)) {
      if (bl(e))
        throw Wc(), Error(r(418));
      for (; t; )
        Fc(e, t), t = ln(t.nextSibling);
    }
    if (Bc(e), e.tag === 13) {
  ...
  var ug = $.ReactCurrentBatchConfig;
  function go(e, t, o) {
  ...
  function Vc(e) {
    ...
    function x(T, k, O, F) {
      var Y = O.type;
      return Y === q ? I(T, k, O.props.children, F, O.key) : k !== null && (k.elementType === Y || typeof Y == "object" && Y !== null && Y.$$typeof === he && Hc(Y) === k.type) ? (F = c(k, O.props), F.ref = go(T, k, O), F.return = T, F) : (F = Gi(O.type, O.key, O.props, null, T.mode, F), F.ref = go(T, k, O), F.return = T, F);
    }
    function R(T, k, O, F) {
    ...
    function J(T, k, O, F) {
      ...
      return e && te.forEach(function(Bg) {
        return t(T, Bg);
      }), Ae && Dn(T, re), Y;
    }
    function $e(T, k, O, F) {
            ...
            e: {
              for (var Y = O.key, ee = k; ee !== null; ) {
                if (ee.key === Y) {
                  ...
                  } else if (ee.elementType === Y || typeof Y == "object" && Y !== null && Y.$$typeof === he && Hc(Y) === ee.type) {
  ...
  var vr = Vc(!0), Kc = Vc(!1), bi = an(null), Ei = null, yr = null, Pl = null;
  function Tl() {
    Pl = yr = Ei = null;
  }
  function Ol(e) {
  ...
  var Oi = $.ReactCurrentDispatcher, Dl = $.ReactCurrentBatchConfig, Fn = 0, Ne = null, ze = null, Fe = null, Ri = !1, _o = !1, xo = 0, cg = 0;
  function Ke() {
    throw Error(r(321));
  }
  function zl(e, t) {
  ...
  function Ml(e, t, o, l, c, d) {
    if (Fn = d, Ne = t, t.memoizedState = null, t.updateQueue = null, t.lanes = 0, Oi.current = e === null || e.memoizedState === null ? pg : mg, e = o(l, c), _o) {
      d = 0;
      do {
        if (_o = !1, xo = 0, 25 <= d)
          throw Error(r(301));
        d += 1, Fe = ze = null, t.updateQueue = null, Oi.current = gg, e = o(l, c);
      } while (_o);
    }
  ...
  function Zc(e, t) {
    ...
    if (d && (l.memoizedState = c, tt = !0), l = l.queue, Wl(nd.bind(null, o, l, e), [e]), l.getSnapshot !== t || d || Fe !== null && Fe.memoizedState.tag & 1) {
      if (o.flags |= 2048, So(9, td.bind(null, o, l, c, t), void 0, null), Ue === null)
        throw Error(r(349));
      Fn & 30 || ed(o, t, c);
    }
    return c;
  ...
  function td(e, t, o, l) {
    t.value = o, t.getSnapshot = l, rd(t) && od(e);
  }
  function nd(e, t, o) {
    return o(function() {
      rd(t) && od(e);
  ...
  function id(e) {
    var t = It();
    return typeof e == "function" && (e = e()), t.memoizedState = t.baseState = e, e = { pending: null, interleaved: null, lanes: 0, dispatch: null, lastRenderedReducer: ko, lastRenderedState: e }, t.queue = e, e = e.dispatch = hg.bind(null, Ne, e), [t.memoizedState, e];
  }
  function So(e, t, o, l) {
  ...
  function dd(e, t, o) {
    return o = o != null ? o.concat([e]) : null, ji(4, 4, cd.bind(null, t, e), o);
  }
  function Hl() {
  }
  function fd(e, t) {
  ...
  function pd(e, t, o) {
    return Fn & 21 ? (kt(o, t) || (o = Hu(), Ne.lanes |= o, Un |= o, e.baseState = !0), t) : (e.baseState && (e.baseState = !1, tt = !0), e.memoizedState = o);
  }
  function dg(e, t) {
    var o = Se;
    Se = o !== 0 && 4 > o ? o : 4, e(!0);
  ...
  function fg(e, t, o) {
    var l = gn(e);
    if (o = { lane: l, action: o, hasEagerState: !1, eagerState: null, next: null }, gd(e))
      vd(t, o);
    else if (o = Gc(e, t, o, l), o !== null) {
      var c = Xe();
      Pt(o, e, l, c), yd(o, t, l);
    }
  }
  function hg(e, t, o) {
    ...
    if (gd(e))
      ...
      o = Gc(e, t, c, l), o !== null && (c = Xe(), Pt(o, e, l, c), yd(o, t, l));
    }
  }
  function gd(e) {
    var t = e.alternate;
  ...
  var Ni = { readContext: pt, useCallback: Ke, useContext: Ke, useEffect: Ke, useImperativeHandle: Ke, useInsertionEffect: Ke, useLayoutEffect: Ke, useMemo: Ke, useReducer: Ke, useRef: Ke, useState: Ke, useDebugValue: Ke, useDeferredValue: Ke, useTransition: Ke, useMutableSource: Ke, useSyncExternalStore: Ke, useId: Ke, unstable_isNewReconciler: !1 }, pg = { readContext: pt, useCallback: function(e, t) {
    return It().memoizedState = [e, t === void 0 ? null : t], e;
  }, useContext: pt, useEffect: ld, useImperativeHandle: function(e, t, o) {
    ...
    var l = It();
    return t = o !== void 0 ? o(t) : t, l.memoizedState = l.baseState = t, e = { pending: null, interleaved: null, lanes: 0, dispatch: null, lastRenderedReducer: e, lastRenderedState: t }, l.queue = e, e = e.dispatch = fg.bind(null, Ne, e), [l.memoizedState, e];
  }, useRef: function(e) {
    var t = It();
    return e = { current: e }, t.memoizedState = e;
  }, useState: id, useDebugValue: Hl, useDeferredValue: function(e) {
    return It().memoizedState = e;
  }, useTransition: function() {
    var e = id(!1), t = e[0];
    return e = dg.bind(null, e[1]), It().memoizedState = e, [t, e];
    ...
    return c.queue = d, ld(nd.bind(
      null,
      l,
      d,
      e
    ), [e]), l.flags |= 2048, So(9, td.bind(null, l, d, o, t), void 0, null), o;
  }, useId: function() {
    ...
    useDeferredValue: function(e) {
      var t = mt();
      return pd(t, ze.memoizedState, e);
    },
    useTransition: function() {
  ...
  }, gg = { readContext: pt, useCallback: fd, useContext: pt, useEffect: Wl, useImperativeHandle: dd, useInsertionEffect: ad, useLayoutEffect: ud, useMemo: hd, useReducer: Bl, useRef: sd, useState: function() {
    return Bl(ko);
  }, useDebugValue: Hl, useDeferredValue: function(e) {
    var t = mt();
    return ze === null ? t.memoizedState = e : pd(t, ze.memoizedState, e);
  }, useTransition: function() {
    var e = Bl(ko)[0], t = mt().memoizedState;
    return [e, t];
  }, useMutableSource: Xc, useSyncExternalStore: Zc, useId: md, unstable_isNewReconciler: !1 };
  function bt(e, t) {
    if (e && e.defaultProps) {
...
` + d.stack;
  ...
  function bd(e, t, o) {
    ...
    c.has(o) || (c.add(o), e = Ag.bind(null, e, t, o), t.then(e, e));
  }
  function Ed(e) {
    do {
      var t;
  ...
  var yg = $.ReactCurrentOwner, tt = !1;
  function Ye(e, t, o, l) {
    t.child = e === null ? Kc(t, null, o, l) : vr(t, e.child, o, l);
  }
  ...
  function Td(e, t, o, l, c) {
    if (e === null) {
      var d = o.type;
      return typeof d == "function" && !ga(d) && d.defaultProps === void 0 && o.compare === null && o.defaultProps === void 0 ? (t.tag = 15, t.type = d, Od(e, t, d, l, c)) : (e = Gi(o.type, null, l, t, t.mode, c), e.ref = t.ref, e.return = t, t.child = e);
    }
  ...
  function jd(e, t, o, l, c) {
    ...
    if (wr(t, c), t.stateNode === null)
      ...
      z || typeof m.UNSAFE_componentWillReceiveProps != "function" && typeof m.componentWillReceiveProps != "function" || (w !== l || x !== R) && xd(t, m, l, R), dn = !1;
      var L = t.memoizedState;
      m.state = L, Pi(t, l, m, c), x = t.memoizedState, w !== l || L !== x || Ze.current || dn ? (typeof I == "function" && (Vl(t, o, I, l), x = t.memoizedState), (w = dn || wd(t, o, w, l, L, x, R)) ? (z || typeof m.UNSAFE_componentWillMount != "function" && typeof m.componentWillMount != "function" || (typeof m.componentWillMount == "function" && m.componentWillMount(), typeof m.UNSAFE_componentWillMount == "function" && m.UNSAFE_componentWillMount()), typeof m.componentDidMount == "function" && (t.flags |= 4194308)) : (typeof m.componentDidMount == "function" && (t.flags |= 4194308), t.memoizedProps = l, t.memoizedState = x), m.props = l, m.state = x, m.context = R, l = w) : (typeof m.componentDidMount == "function" && (t.flags |= 4194308), l = !1);
    } else {
      m = t.stateNode, Qc(e, t), w = t.memoizedProps, R = t.type === t.elementType ? w : bt(t.type, w), m.props = R, z = t.pendingProps, L = m.context, x = o.contextType, typeof x == "object" && x !== null ? x = pt(x) : (x = et(o) ? In : Ve.current, x = hr(t, x));
      var K = o.getDerivedStateFromProps;
      (I = typeof K == "function" || typeof m.getSnapshotBeforeUpdate == "function") || typeof m.UNSAFE_componentWillReceiveProps != "function" && typeof m.componentWillReceiveProps != "function" || (w !== z || L !== x) && xd(t, m, l, x), dn = !1, L = t.memoizedState, m.state = L, Pi(t, l, m, c);
      var Q = t.memoizedState;
      w !== z || L !== Q || Ze.current || dn ? (typeof K == "function" && (Vl(t, o, K, l), Q = t.memoizedState), (R = dn || wd(t, o, R, l, L, Q, x) || !1) ? (I || typeof m.UNSAFE_componentWillUpdate != "function" && typeof m.componentWillUpdate != "function" || (typeof m.componentWillUpdate == "function" && m.componentWillUpdate(l, Q, x), typeof m.UNSAFE_componentWillUpdate == "function" && m.UNSAFE_componentWillUpdate(l, Q, x)), typeof m.componentDidUpdate == "function" && (t.flags |= 4), typeof m.getSnapshotBeforeUpdate == "function" && (t.flags |= 1024)) : (typeof m.componentDidUpdate != "function" || w === e.memoizedProps && L === e.memoizedState || (t.flags |= 4), typeof m.getSnapshotBeforeUpdate != "function" || w === e.memoizedProps && L === e.memoizedState || (t.flags |= 1024), t.memoizedProps = l, t.memoizedState = Q), m.props = l, m.state = Q, m.context = x, l = R) : (typeof m.componentDidUpdate != "function" || w === e.memoizedProps && L === e.memoizedState || (t.flags |= 4), typeof m.getSnapshotBeforeUpdate != "function" || w === e.memoizedProps && L === e.memoizedState || (t.flags |= 1024), l = !1);
    }
  ...
  function Jl(e, t, o, l, c, d) {
    ...
    var m = (t.flags & 128) !== 0;
    if (!l && !m)
      return c && Dc(t, o, !1), Qt(e, t, d);
    l = t.stateNode, yg.current = t;
    var w = m && typeof o.getDerivedStateFromError != "function" ? null : l.render();
    return t.flags |= 1, e !== null && m ? (t.child = vr(t, e.child, null, d), t.child = vr(t, null, w, d)) : Ye(e, t, w, d), t.memoizedState = l.state, c && Dc(t, o, !0), t.child;
  }
  function Nd(e) {
    var t = e.stateNode;
    t.pendingContext ? Ic(e, t.pendingContext, t.pendingContext !== t.context) : t.context && Ic(e, t.context, !1), Nl(e, t.containerInfo);
  }
  function Ld(e, t, o, l, c) {
  ...
  function wg(e, t, o, l, c, d, m) {
    ...
    return c.data === "$?" ? (t.flags |= 128, t.child = e.child, t = jg.bind(null, e), c._reactRetry = t, null) : (e = d.treeContext, lt = ln(c.nextSibling), st = t, Ae = !0, St = null, e !== null && (ft[ht++] = Ht, ft[ht++] = Vt, ft[ht++] = $n, Ht = e.id, Vt = e.overflow, $n = t), t = Zl(t, l.children), t.flags |= 4096, t);
  }
  function $d(e, t, o) {
    e.lanes |= t;
    var l = e.alternate;
    ...
    switch (t.tag) {
      ...
      case 13:
        if (l = t.memoizedState, l !== null)
          return l.dehydrated !== null ? (Ce(je, je.current & 1), t.flags |= 128, null) : o & t.child.childLanes ? Id(e, t, o) : (Ce(je, je.current & 1), e = Qt(e, t, o), e !== null ? e.sibling : null);
        Ce(je, je.current & 1);
        break;
      case 19:
    ...
    switch (Sl(t), t.tag) {
      ...
      case 5:
        ...
        if (o = t.type, e !== null && t.stateNode != null)
          Md(e, t, o, l, c), e.ref !== t.ref && (t.flags |= 512, t.flags |= 2097152);
        else {
          if (!l) {
            if (t.stateNode === null)
              throw Error(r(166));
            ...
            e: {
              ...
              for (d in w)
                if (w.hasOwnProperty(d)) {
                  var x = w[d];
                  d === "style" ? Ou(e, x) : d === "dangerouslySetInnerHTML" ? (x = x ? x.__html : void 0, x != null && Pu(e, x)) : d === "children" ? typeof x == "string" ? (o !== "textarea" || x !== "") && Vr(e, x) : typeof x == "number" && Vr(e, "" + x) : d !== "suppressContentEditableWarning" && d !== "suppressHydrationWarning" && d !== "autoFocus" && (a.hasOwnProperty(d) ? x != null && d === "onScroll" && Te("scroll", e) : x != null && B(e, d, x, m));
                }
              switch (o) {
                case "input":
                  er(e), ku(e, l, !1);
  ...
  var Di = !1, Qe = !1, Sg = typeof WeakSet == "function" ? WeakSet : Set, G = null;
  function kr(e, t) {
    var o = e.ref;
    if (o !== null)
  ...
  function Bd(e) {
    var t = e.alternate;
    t !== null && (e.alternate = null, Bd(t)), e.child = null, e.deletions = null, e.sibling = null, e.tag === 5 && (t = e.stateNode, t !== null && (delete t[Nt], delete t[po], delete t[wl], delete t[sg], delete t[lg])), e.stateNode = null, e.return = null, e.dependencies = null, e.memoizedProps = null, e.memoizedState = null, e.pendingProps = null, e.stateNode = null, e.updateQueue = null;
  }
  function Wd(e) {
  ...
  function Kd(e) {
    ...
    if (t !== null) {
      e.updateQueue = null;
      var o = e.stateNode;
      o === null && (o = e.stateNode = new Sg()), t.forEach(function(l) {
        var c = Ng.bind(null, e, l);
  ...
  function Gd(e, t) {
    ...
    switch (e.tag) {
      ...
      case 5:
        ...
        if (l & 4 && (c = e.stateNode, c != null)) {
          ...
          if (e.updateQueue = null, x !== null)
            try {
              w === "input" && d.type === "radio" && d.name != null && xu(c, d), $s(w, m);
              var R = $s(w, d);
              for (m = 0; m < x.length; m += 2) {
                var I = x[m], z = x[m + 1];
                I === "style" ? Ou(c, z) : I === "dangerouslySetInnerHTML" ? Pu(c, z) : I === "children" ? Vr(c, z) : B(c, I, z, R);
              }
              switch (w) {
                case "input":
                  As(c, d);
      ...
      case 4:
        ...
        break;
      case 13:
        Ct(t, e), $t(e), c = e.child, c.flags & 8192 && (d = c.memoizedState !== null, c.stateNode.isHidden = d, !d || c.alternate !== null && c.alternate.memoizedState !== null || (aa = Ie())), l & 4 && Kd(e);
        break;
      case 22:
            ...
            for (I = null, z = e; ; ) {
              if (z.tag === 5) {
                if (I === null) {
                  I = z;
                  try {
                    c = z.stateNode, R ? (d = c.style, typeof d.setProperty == "function" ? d.setProperty("display", "none", "important") : d.display = "none") : (w = z.stateNode, x = z.memoizedProps.style, m = x != null && x.hasOwnProperty("display") ? x.display : null, w.style.display = Tu("display", m));
                  } catch (J) {
                    Le(e, e.return, J);
                  }
                }
    ...
    if (t & 2) {
      try {
        ...
        switch (l.tag) {
          ...
          case 3:
          case 4:
            var m = l.stateNode.containerInfo, w = Hd(e);
            oa(e, w, m);
            break;
          default:
            throw Error(r(161));
    ...
    for (var l = (e.mode & 1) !== 0; G !== null; ) {
      ...
      if (c.tag === 22 && l) {
        ...
        if (!m) {
          ...
          if (Di = m, (Qe = x) && !R)
            for (G = c; G !== null; )
              m = G, x = m.child, m.tag === 22 && m.memoizedState !== null ? Yd(c) : x !== null ? (x.return = m, G = x) : Yd(c);
          for (; d !== null; )
            G = d, Qd(d), d = d.sibling;
          G = c, Di = w, Qe = R;
        }
        qd(e);
      } else
        c.subtreeFlags & 8772 && d !== null ? (d.return = c, G = d) : qd(e);
    }
  }
  function qd(e) {
    for (; G !== null; ) {
  ...
  var Cg = Math.ceil, Mi = $.ReactCurrentDispatcher, sa = $.ReactCurrentOwner, gt = $.ReactCurrentBatchConfig, ve = 0, Ue = null, De = null, He = 0, at = 0, Sr = an(0), Me = 0, Co = null, Un = 0, Fi = 0, la = 0, Po = null, nt = null, aa = 0, br = 1 / 0, qt = null, Ui = !1, ua = null, pn = null, Bi = !1, mn = null, Wi = 0, To = 0, ca = null, Hi = -1, Vi = 0;
  function Xe() {
    return ve & 6 ? Ie() : Hi !== -1 ? Hi : Hi = Ie();
  }
  function gn(e) {
    return e.mode & 1 ? ve & 2 && He !== 0 ? He & -He : ug.transition !== null ? (Vi === 0 && (Vi = Hu()), Vi) : (e = Se, e !== 0 || (e = window.event, e = e === void 0 ? 16 : Zu(e.type)), e) : 1;
  }
  function Pt(e, t, o, l) {
    if (50 < To)
  ...
  function rt(e, t) {
    ...
    if (l === 0)
      o !== null && Uu(o), e.callbackNode = null, e.callbackPriority = 0;
    else if (t = l & -l, e.callbackPriority !== t) {
      if (o != null && Uu(o), t === 1)
        e.tag === 0 ? ag(Zd.bind(null, e)) : zc(Zd.bind(null, e)), og(function() {
          !(ve & 6) && cn();
        }), o = null;
      else {
        switch (Vu(l)) {
  ...
  function Xd(e, t) {
    ...
    if (t !== 0) {
      ...
      if (t === 6)
        ...
        if (c = e.current.alternate, !(l & 30) && !Pg(c) && (t = Ki(e, l), t === 2 && (d = Hs(e), d !== 0 && (l = d, t = da(e, d))), t === 1))
          throw o = Co, Wn(e, 0), vn(e, l), rt(e, Ie()), o;
        switch (e.finishedWork = c, e.finishedLanes = l, t) {
          ...
          case 4:
            ...
            if (l = c, l = Ie() - l, l = (120 > l ? 120 : 480 > l ? 480 : 1080 > l ? 1080 : 1920 > l ? 1920 : 3e3 > l ? 3e3 : 4320 > l ? 4320 : 1960 * Cg(l / 1960)) - l, 10 < l) {
    ...
    return rt(e, Ie()), e.callbackNode === o ? Xd.bind(null, e) : null;
  }
  function da(e, t) {
    var o = Po;
  ...
  function Wn(e, t) {
    ...
    if (o !== -1 && (e.timeoutHandle = -1, rg(o)), De !== null)
      ...
      try {
        ...
        e: {
          ...
          if (t = He, w.flags |= 32768, x !== null && typeof x == "object" && typeof x.then == "function") {
            ...
            var K = Ed(m);
            if (K !== null) {
              K.flags &= -257, Cd(K, m, w, d, t), K.mode & 1 && bd(d, R, t), t = K, x = R;
              var Q = t.updateQueue;
              if (Q === null) {
            ...
            var $e = Ed(m);
            if ($e !== null) {
              !($e.flags & 65536) && ($e.flags |= 256), Cd($e, m, w, d, t), Cl(xr(x, w));
              break e;
            }
          }
  ...
  function nf(e) {
    var t = lf(e.alternate, e, at);
    e.memoizedProps = e.pendingProps, t === null ? rf(e) : De = t, sa.current = null;
  }
  function rf(e) {
    var t = e;
    do {
  ...
  function Hn(e, t, o) {
    ...
    try {
      gt.transition = null, Se = 1, Rg(e, t, o, l);
    } finally {
  ...
  function Rg(e, t, o, l) {
    ...
    if (cm(e, d), e === Ue && (De = Ue = null, He = 0), !(o.subtreeFlags & 2064) && !(o.flags & 2064) || Bi || (Bi = !0, af(Jo, function() {
      return Er(), null;
      ...
      Se = 1;
      var w = ve;
      ve |= 4, sa.current = null, bg(e, o), Gd(o, e), Jm(ml), ri = !!pl, ml = pl = null, e.current = o, Eg(o), tm(), ve = w, Se = m, gt.transition = d;
    } else
      e.current = o;
    if (Bi && (Bi = !1, mn = e, Wi = c), d = e.pendingLanes, d === 0 && (pn = null), om(o.stateNode), rt(e, Ie()), t !== null)
  ...
  function Er() {
    if (mn !== null) {
      var e = Vu(Wi), t = gt.transition, o = Se;
      try {
  ...
  function of(e, t, o) {
    t = xr(o, t), t = kd(e, t, 1), e = fn(e, t, 1), t = Xe(), e !== null && (Yr(e, 1, t), rt(e, t));
  }
  function Le(e, t, o) {
    if (e.tag === 3)
      of(e, e, o);
      ...
      for (; t !== null; ) {
        if (t.tag === 3) {
          ...
          if (typeof t.type.getDerivedStateFromError == "function" || typeof l.componentDidCatch == "function" && (pn === null || !pn.has(l))) {
            e = xr(o, e), e = Sd(t, e, 1), t = fn(t, e, 1), e = Xe(), t !== null && (Yr(t, 1, e), rt(t, e));
            break;
          }
        }
        t = t.return;
  ...
  lf = function(e, t, o) {
    if (e !== null)
      if (e.memoizedProps !== t.pendingProps || Ze.current)
        ...
        if (!(e.lanes & o) && !(t.flags & 128))
          return tt = !1, _g(e, t, o);
        tt = !!(e.flags & 131072);
      }
    else
      tt = !1, Ae && t.flags & 1048576 && Mc(t, xi, t.index);
    switch (t.lanes = 0, t.tag) {
      ...
      case 16:
        l = t.elementType;
        e: {
          switch ($i(e, t), e = t.pendingProps, c = l._init, l = c(l._payload), t.type = l, c = t.tag = Ig(l), e = bt(l, e), c) {
            case 0:
              t = ql(null, t, l, e, o);
              break e;
            case 1:
      ...
      case 1:
        return l = t.type, c = t.pendingProps, c = t.elementType === l ? c : bt(l, c), jd(e, t, l, c, o);
      case 3:
        e: {
          if (Nd(t), e === null)
            throw Error(r(387));
          l = t.pendingProps, d = t.memoizedState, c = d.element, Qc(e, t), Pi(t, l, null, o);
          ...
          if (l = m.element, d.isDehydrated)
            if (d = { element: l, isDehydrated: !1, cache: m.cache, pendingSuspenseBoundaries: m.pendingSuspenseBoundaries, transitions: m.transitions }, t.updateQueue.baseState = d, t.memoizedState = d, t.flags & 256) {
              c = xr(Error(r(423)), t), t = Ld(e, t, l, o, c);
              break e;
            } else if (l !== c) {
              c = xr(Error(r(424)), t), t = Ld(e, t, l, o, c);
              break e;
            } else
              for (lt = ln(t.stateNode.containerInfo.firstChild), st = t, Ae = !0, St = null, o = Kc(t, null, l, o), t.child = o; o; )
        ...
        return t;
      case 5:
        return Yc(t), e === null && El(t), l = t.type, c = t.pendingProps, d = e !== null ? e.memoizedProps : null, m = c.children, gl(l, c) ? m = null : d !== null && gl(l, d) && (t.flags |= 32), Ad(e, t), Ye(e, t, m, o), t.child;
      case 6:
      ...
      case 11:
        return l = t.type, c = t.pendingProps, c = t.elementType === l ? c : bt(l, c), Pd(e, t, l, c, o);
      case 7:
      ...
      case 14:
        return l = t.type, c = bt(l, t.pendingProps), c = bt(l.type, c), Td(e, t, l, c, o);
      case 15:
        return Od(e, t, t.type, t.pendingProps, o);
      case 17:
        return l = t.type, c = t.pendingProps, c = t.elementType === l ? c : bt(l, c), $i(e, t), t.tag = 1, et(l) ? (e = !0, yi(t)) : e = !1, wr(t, o), _d(t, l, c), Kl(t, l, c, o), Jl(null, t, l, !0, e, o);
      case 19:
        return Dd(e, t, o);
      case 22:
        return Rd(e, t, o);
  ...
  function wa(e, t, o, l, c, d, m, w, x) {
    return e = new $g(e, t, o, w, x), t === 1 ? (t = 1, d === !0 && (t |= 8)) : t = 0, d = vt(3, null, null, t), e.current = d, d.stateNode = e, d.memoizedState = { element: l, isDehydrated: o, cache: null, transitions: null, pendingSuspenseBoundaries: null }, jl(d), e;
  }
  function Dg(e, t, o) {
  ...
  function cf(e, t, o, l, c, d, m, w, x) {
    return e = wa(o, l, !0, e, c, d, m, w, x), e.context = uf(null), o = e.current, l = Xe(), c = gn(o), d = Gt(l, c), d.callback = t ?? null, fn(o, d, c), e.current.lanes = c, Yr(e, c, l), rt(e, l), e;
  }
  function qi(e, t, o, l) {
    var c = t.current, d = Xe(), m = gn(c);
    return o = uf(o), t.context === null ? t.context = o : t.pendingContext = o, t = Gt(d, m), t.payload = { element: e }, l = l === void 0 ? null : l, l !== null && (t.callback = l), e = fn(c, t, m), e !== null && (Pt(e, c, m, d), Ci(e, c, m)), m;
  }
  function Ji(e) {
  ...
  function Mg(e, t, o, l, c) {
    ...
    var x = wa(e, 0, !1, null, null, !1, !1, "", hf);
  ...
  var Fg = { usingClientEntryPoint: !1, Events: [mo, dr, gi, Au, ju, ha] }, Oo = { findFiberByHostInstance: Ln, bundleType: 0, version: "18.3.1", rendererPackageName: "react-dom" }, Ug = { bundleType: Oo.bundleType, version: Oo.version, rendererPackageName: Oo.rendererPackageName, rendererConfig: Oo.rendererConfig, overrideHookState: null, overrideHookStateDeletePath: null, overrideHookStateRenamePath: null, overrideProps: null, overridePropsDeletePath: null, overridePropsRenamePath: null, setErrorHandler: null, setSuspenseHandler: null, scheduleUpdate: null, currentDispatcherRef: $.ReactCurrentDispatcher, findHostInstanceByFiber: function(e) {
    return e = zu(e), e === null ? null : e.stateNode;
  }, findFiberByHostInstance: Oo.findFiberByHostInstance || zg, findHostInstancesForRefresh: null, scheduleRefresh: null, scheduleRoot: null, setRefreshHandler: null, getCurrentFiber: null, reconcilerVersion: "18.3.1-next-f1338f8080-20240426" };
  if (typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u") {
    var es = __REACT_DEVTOOLS_GLOBAL_HOOK__;
    if (!es.isDisabled && es.supportsFiber)
      try {
        Yo = es.inject(Ug), jt = es;
      } catch {
      }
  }
  return ot.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = Fg, ot.createPortal = function(e, t) {
    var o = 2 < arguments.length && arguments[2] !== void 0 ? arguments[2] : null;
    if (!ka(t))
      throw Error(r(200));
    return Dg(e, t, null, o);
    ...
    if (!ka(e))
      throw Error(r(405));
    var l = o != null && o.hydratedSources || null, c = !1, d = "", m = ff;
    if (o != null && (o.unstable_strictMode === !0 && (c = !0), o.identifierPrefix !== void 0 && (d = o.identifierPrefix), o.onRecoverableError !== void 0 && (m = o.onRecoverableError)), t = cf(t, null, e, 1, o ?? null, c, !1, d, m), e[Bt] = t.current, fo(e), l)
...
ph(), hh.exports = qg();
var Uo = hh.exports;
const Jg = /* @__PURE__ */ dh(Uo);
var _f = Uo;
Fa.createRoot = _f.createRoot, Fa.hydrateRoot = _f.hydrateRoot;
var C = tu();
const Yg = /* @__PURE__ */ dh(C), Xg = /* @__PURE__ */ Wg({
  __proto__: null,
  default: Yg
}, [C]);
function Zg(i, n) {
...
function mh(...i) {
  return (n) => i.forEach((r) => Zg(r, n));
}
function An(...i) {
  return C.useCallback(mh(...i), i);
}
var ws = C.forwardRef((i, n) => {
  const { children: r, ...s } = i, a = C.Children.toArray(r), u = a.find(tv);
  if (u) {
    ...
    return /* @__PURE__ */ W.jsx(Ua, { ...s, ref: n, children: C.isValidElement(f) ? C.cloneElement(f, void 0, h) : null });
  }
  return /* @__PURE__ */ W.jsx(Ua, { ...s, ref: n, children: r });
});
ws.displayName = "Slot";
var Ua = C.forwardRef((i, n) => {
...
var ev = ({ children: i }) => /* @__PURE__ */ W.jsx(W.Fragment, { children: i });
function tv(i) {
  return C.isValidElement(i) && i.type === ev;
}
function nv(i, n) {
  const r = { ...n };
  for (const s in n) {
...
function ov() {
  for (var i, n, r = 0, s = ""; r < arguments.length; )
    (i = arguments[r++]) && (n = gh(i)) && (s && (s += " "), s += n);
  return s;
}
const xf = (i) => typeof i == "boolean" ? "".concat(i) : i === 0 ? "0" : i, kf = ov, vh = (i, n) => (r) => {
  var s;
  if (n?.variants == null)
    return kf(i, r?.class, r?.className);
  ...
  return kf(i, f, p, r?.class, r?.className);
};
function yh(i) {
  var n, r, s = "";
  if (typeof i == "string" || typeof i == "number")
...
function sv(i) {
  ...
  function a(f) {
    const h = f.split(nu);
    return h[0] === "" && h.length !== 1 && h.shift(), wh(h, n) || lv(f);
  }
  function u(f, h) {
    const p = r[f] || [];
...
function wh(i, n) {
  ...
  const r = i[0], s = n.nextPart.get(r), a = s ? wh(i.slice(1), s) : void 0;
  if (a)
    return a;
...
function lv(i) {
  if (Sf.test(i)) {
    const n = Sf.exec(i)[1], r = n?.substring(0, n.indexOf(":"));
    if (r)
      return "arbitrary.." + r;
  }
}
function av(i) {
  ...
  return cv(Object.entries(i.classGroups), r).forEach(([u, f]) => {
    Ba(f, s, u, n);
  }), s;
}
function Ba(i, n, r, s) {
...
function fv(i) {
  ...
  function f(h) {
    ...
    const _ = p.length === 0 ? h : h.substring(v), b = _.startsWith(_h), A = b ? _.substring(1) : _, S = y && y > v ? y - v : void 0;
    return {
      modifiers: p,
...
function yv(i, ...n) {
  ...
  function f(p) {
    ...
    return r = pv(g), s = r.cache.get, a = r.cache.set, u = h, h(p);
  }
  function h(p) {
    const g = s(p);
    if (g)
  ...
  return function() {
    return u(vv.apply(null, arguments));
  };
}
function Re(i) {
  const n = (r) => r[i] || [];
...
const kh = /^\[(?:([a-z-]+):)?(.+)\]$/i, wv = /^\d+\/\d+$/, _v = /* @__PURE__ */ new Set(["px", "full", "screen"]), xv = /^(\d+(\.\d+)?)?(xs|sm|md|lg|xl)$/, kv = /\d+(%|px|r?em|[sdl]?v([hwib]|min|max)|pt|pc|in|cm|mm|cap|ch|ex|r?lh|cq(w|h|i|b|min|max))|\b(calc|min|max|clamp)\(.+\)|^0$/, Sv = /^(rgba?|hsla?|hwb|(ok)?(lab|lch))\(.+\)$/, bv = /^(inset_)?-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/, Ev = /^(url|image|image-set|cross-fade|element|(repeating-)?(linear|radial|conic)-gradient)\(.+\)$/;
function Jt(i) {
  return Jn(i) || _v.has(i) || wv.test(i);
}
function _n(i) {
  return zr(i, "length", Nv);
}
function Jn(i) {
...
function Ov(i) {
  return zr(i, "position", Sh);
}
const Rv = /* @__PURE__ */ new Set(["image", "url"]);
function Av(i) {
  return zr(i, Rv, Iv);
}
function jv(i) {
...
function $v() {
  ...
  return {
    ...
    theme: {
      ...
      gradientColorStopPositions: [Cv, _n],
      inset: be(),
      margin: be(),
      opacity: E(),
      padding: ne(),
...
), Wa = C.forwardRef(({ className: i, variant: n, size: r, asChild: s = !1, ...a }, u) => {
  const f = s ? ws : "button";
  return /* @__PURE__ */ W.jsx(
    f,
    {
      className: Mr(zv({ variant: n, size: r, className: i })),
      ref: u,
      ...a
    }
  );
...
var Uv = "Label", bh = C.forwardRef((i, n) => /* @__PURE__ */ W.jsx(
  At.label,
  {
    ...i,
    ref: n,
...
), ds = C.forwardRef(({ className: i, ...n }, r) => /* @__PURE__ */ W.jsx(Eh, { ref: r, className: Mr(Bv(), i), ...n }));
ds.displayName = Eh.displayName;
const Ha = C.forwardRef(({ className: i, type: n, ...r }, s) => /* @__PURE__ */ W.jsx(
  "input",
  {
    type: n,
    className: Mr(
...
const Ch = C.forwardRef(({ className: i, ...n }, r) => /* @__PURE__ */ W.jsx(
  "textarea",
  {
    className: Mr(
...
Ch.displayName = "Textarea";
var Wv = "Separator", Ef = "horizontal", Hv = ["horizontal", "vertical"], Ph = C.forwardRef((i, n) => {
  const { decorative: r, orientation: s = Ef, ...a } = i, u = Vv(s) ? s : Ef, h = r ? { role: "none" } : { "aria-orientation": u === "vertical" ? u : void 0, role: "separator" };
  return /* @__PURE__ */ W.jsx(
    At.div,
    {
      "data-orientation": u,
...
var Th = Ph;
const Oh = C.forwardRef(({ className: i, orientation: n = "horizontal", decorative: r = !0, ...s }, a) => /* @__PURE__ */ W.jsx(
  Th,
  {
    ref: a,
    decorative: r,
...
function Gv(i, n = globalThis?.document) {
  const r = Pn(i);
  C.useEffect(() => {
    const s = (a) => {
      a.key === "Escape" && r(a);
...
var Qv = "DismissableLayer", Va = "dismissableLayer.update", qv = "dismissableLayer.pointerDownOutside", Jv = "dismissableLayer.focusOutside", Cf, Ah = C.createContext({
  ...
  (i, n) => {
    const {
      ...
      onDismiss: h,
      ...p
    } = i, g = C.useContext(Ah), [v, y] = C.useState(null), _ = v?.ownerDocument ?? globalThis?.document, [, b] = C.useState({}), A = An(n, (q) => y(q)), S = Array.from(g.layers), [P] = [...g.layersWithOutsidePointerEventsDisabled].slice(-1), j = S.indexOf(P), M = v ? S.indexOf(v) : -1, B = g.layersWithOutsidePointerEventsDisabled.size > 0, $ = M >= j, U = Zv((q) => {
    ...
    return Gv((q) => {
      ...
      if (v)
        return r && (g.layersWithOutsidePointerEventsDisabled.size === 0 && (Cf = _.body.style.pointerEvents, _.body.style.pointerEvents = "none"), g.layersWithOutsidePointerEventsDisabled.add(v)), g.layers.add(v), Pf(), () => {
          r && g.layersWithOutsidePointerEventsDisabled.size === 1 && (_.body.style.pointerEvents = Cf);
        };
    }, [v, _, r, g]), C.useEffect(() => () => {
      v && (g.layers.delete(v), g.layersWithOutsidePointerEventsDisabled.delete(v), Pf());
    }, [v, g]), C.useEffect(() => {
      const q = () => b({});
      return document.addEventListener(Va, q), () => document.removeEventListener(Va, q);
    }, []), /* @__PURE__ */ W.jsx(
      At.div,
      {
        ...p,
...
jh.displayName = Qv;
var Yv = "DismissableLayerBranch", Xv = C.forwardRef((i, n) => {
  const r = C.useContext(Ah), s = C.useRef(null), a = An(n, s);
  return C.useEffect(() => {
    const u = s.current;
    if (u)
...
Xv.displayName = Yv;
function Zv(i, n = globalThis?.document) {
...
function ey(i, n = globalThis?.document) {
  const r = Pn(i), s = C.useRef(!1);
  return C.useEffect(() => {
    const a = (u) => {
      u.target && !s.current && Nh(Jv, r, { originalEvent: u }, {
        discrete: !1
      });
    };
...
function Pf() {
  const i = new CustomEvent(Va);
  document.dispatchEvent(i);
}
function Nh(i, n, r, { discrete: s }) {
  const a = r.originalEvent.target, u = new CustomEvent(i, { bubbles: !1, cancelable: !0, detail: r });
  n && a.addEventListener(i, n, { once: !0 }), s ? Fv(a, u) : a.dispatchEvent(u);
}
var Ca = 0;
function ty() {
  C.useEffect(() => {
    const i = document.querySelectorAll("[data-radix-focus-guard]");
    return document.body.insertAdjacentElement("afterbegin", i[0] ?? Tf()), document.body.insertAdjacentElement("beforeend", i[1] ?? Tf()), Ca++, () => {
      Ca === 1 && document.querySelectorAll("[data-radix-focus-guard]").forEach((n) => n.remove()), Ca--;
    };
  }, []);
}
function Tf() {
...
var Pa = "focusScope.autoFocusOnMount", Ta = "focusScope.autoFocusOnUnmount", Of = { bubbles: !1, cancelable: !0 }, ny = "FocusScope", Lh = C.forwardRef((i, n) => {
  const {
    loop: r = !1,
    trapped: s = !1,
    onMountAutoFocus: a,
  ...
  C.useEffect(() => {
    ...
    if (h) {
      ...
      if (!h.contains(S)) {
        const j = new CustomEvent(Pa, Of);
        h.addEventListener(Pa, g), h.dispatchEvent(j), j.defaultPrevented || (ry(ay(Ih(h)), { select: !0 }), document.activeElement === S && kn(h));
      }
      return () => {
        h.removeEventListener(Pa, g), setTimeout(() => {
          const j = new CustomEvent(Ta, Of);
          h.addEventListener(Ta, v), h.dispatchEvent(j), j.defaultPrevented || kn(S ?? document.body, { select: !0 }), h.removeEventListener(Ta, v), Af.remove(b);
        }, 0);
      };
    }
  }, [h, g, v, b]);
  const A = C.useCallback(
    (S) => {
      ...
      if (P && j) {
        const M = S.currentTarget, [B, $] = oy(M);
...
function oy(i) {
  const n = Ih(i), r = Rf(n, i), s = Rf(n.reverse(), i);
  return [r, s];
}
function Ih(i) {
...
function kn(i, { select: n = !1 } = {}) {
  if (i && i.focus) {
    const r = document.activeElement;
    i.focus({ preventScroll: !0 }), i !== r && sy(i) && n && i.select();
  }
}
var Af = ly();
function ly() {
  ...
  return {
    add(n) {
      const r = i[0];
      n !== r && r?.pause(), i = jf(i, n), i.unshift(n);
    },
    remove(n) {
      i = jf(i, n), i[0]?.resume();
    }
...
}, uy = Xg["useId".toString()] || (() => {
}), cy = 0;
function dy(i) {
  const [n, r] = C.useState(uy());
  return Yn(() => {
    i || r((s) => s ?? String(cy++));
  }, [i]), i || (n ? `radix-${n}` : "");
}
const fy = ["top", "right", "bottom", "left"], zt = Math.min, ct = Math.max, ms = Math.round, ns = Math.floor, Tn = (i) => ({
  x: i,
  y: i
}), hy = {
  left: "right",
...
function Ga(i) {
  return i.replace(/start|end/g, (n) => py[n]);
}
function vy(i, n, r) {
...
function yy(i, n, r, s) {
  const a = Fr(i);
  let u = vy(Xt(i), r === "start", s);
  return a && (u = u.map((f) => f + "-" + a), n && (u = u.concat(u.map(Ga)))), u;
}
function gs(i) {
  return i.replace(/left|right|bottom|top/g, (n) => hy[n]);
}
function wy(i) {
  return {
    top: 0,
...
function Nf(i, n, r) {
  ...
  const u = On(n), f = iu(n), h = ou(f), p = Xt(n), g = u === "y", v = s.x + s.width / 2 - a.width / 2, y = s.y + s.height / 2 - a.height / 2, _ = s[h] / 2 - a[h] / 2;
  let b;
  switch (p) {
    case "top":
      b = {
...
async function zo(i, n) {
  ...
  const {
    ...
    altBoundary: _ = !1,
    padding: b = 0
  } = Yt(n, i), A = $h(b), P = h[_ ? y === "floating" ? "reference" : "floating" : y], j = vs(await u.getClippingRect({
...
const xy = (i) => ({
  ...
  async fn(n) {
    ...
    const y = $h(v), _ = {
      x: r,
      y: s
    }, b = iu(a), A = ou(b), S = await f.getDimensions(g), P = b === "y", j = P ? "top" : "left", M = P ? "bottom" : "right", B = P ? "clientHeight" : "clientWidth", $ = u.reference[A] + u.reference[b] - _[b] - u.floating[A], U = _[b] - u.reference[b], Z = await (f.getOffsetParent == null ? void 0 : f.getOffsetParent(g));
    let q = Z ? Z[B] : 0;
    (!q || !await (f.isElement == null ? void 0 : f.isElement(Z))) && (q = h.floating[B] || u.floating[A]);
    const oe = $ / 2 - U / 2, ge = q / 2 - S[A] / 2 - 1, de = zt(y[j], ge), be = zt(y[M], ge), ne = de, xe = q - S[A] - be, ue = q / 2 - S[A] / 2 + oe, ke = Ka(ne, ue, xe), he = !p.arrow && Fr(a) != null && ue !== ke && u.reference[A] / 2 - (ue < ne ? de : be) - S[A] / 2 < 0, X = he ? ue < ne ? ue - ne : ue - xe : 0;
    return {
      [b]: _[b] + X,
      data: {
        [b]: ke,
  ...
  return i === void 0 && (i = {}), {
    ...
    async fn(n) {
      ...
      if ((r = u.arrow) != null && r.alignmentOffset)
        return {};
      const j = Xt(a), M = On(h), B = Xt(h) === h, $ = await (p.isRTL == null ? void 0 : p.isRTL(g.floating)), U = _ || (B || !S ? [gs(h)] : gy(h)), Z = A !== "none";
      !_ && Z && U.push(...yy(h, S, A, $));
  ...
  return i === void 0 && (i = {}), {
    ...
    async fn(n) {
      const {
        ...
        x: r,
        y: s
      }, v = await zo(n, p), y = On(Xt(a)), _ = ru(y);
      let b = g[_], A = g[y];
      if (u) {
...
function Ur(i) {
  return Dh(i) ? (i.nodeName || "").toLowerCase() : "#document";
}
function dt(i) {
  var n;
...
function Zt(i) {
  var n;
  return (n = (Dh(i) ? i.ownerDocument : i.document) || window.document) == null ? void 0 : n.documentElement;
}
function Dh(i) {
...
function zh(i) {
  const n = Rn(i);
  return Ir(n) ? i.ownerDocument ? i.ownerDocument.body : i.body : Ft(n) && Bo(n) ? n : zh(n);
}
function Mo(i, n, r) {
  var s;
  n === void 0 && (n = []), r === void 0 && (r = !0);
  const a = zh(i), u = a === ((s = i.ownerDocument) == null ? void 0 : s.body), f = dt(a);
...
const Ay = /* @__PURE__ */ Tn(0);
function Fh(i) {
  const n = dt(i);
  return !lu() || !n.visualViewport ? Ay : {
...
function Xn(i, n, r, s) {
  ...
  const a = i.getBoundingClientRect(), u = au(i);
  let f = Tn(1);
  n && (s ? Mt(s) && (f = jr(s)) : f = jr(i));
  const h = jy(u, r, s) ? Fh(u) : Tn(0);
...
function Bh(i, n) {
  const r = Rn(i);
  return r === n || !Mt(r) || Ir(r) ? !1 : Rt(r).position === "fixed" || Bh(r, n);
}
function zy(i, n) {
  const r = n.get(i);
  if (r)
  ...
  for (; Mt(f) && !Ir(f); ) {
    const h = Rt(f), p = su(f);
    !p && h.position === "fixed" && (a = null), (u ? !p && !a : !p && h.position === "static" && !!a && ["absolute", "fixed"].includes(a.position) || Bo(f) && !p && Bh(i, f)) ? s = s.filter((v) => v !== f) : a = h, f = Rn(f);
  }
  return n.set(i, s), s;
}
function My(i) {
  ...
  const f = [...r === "clippingAncestors" ? _s(n) ? [] : zy(n, this._c) : [].concat(r), s], h = f[0], p = f.reduce((g, v) => {
    const y = Df(n, v, a);
...
function Wh(i, n) {
  ...
  for (; s && Oy(s) && Oa(s); )
    s = zf(s, n);
  return s && Ir(s) && Oa(s) && !su(s) ? r : s || Ry(i) || r;
}
const By = async function(i) {
  const n = this.getOffsetParent || Wh, r = this.getDimensions, s = await r(i.floating);
  return {
    reference: Uy(i.reference, await n(i.floating), i.strategy),
    floating: {
      x: 0,
      y: 0,
      width: s.width,
...
const Gy = Ey, Qy = Cy, qy = ky, Jy = Ty, Yy = Sy, Mf = xy, Xy = Py, Zy = (i, n, r) => {
...
function e0(i) {
  ...
  const [A, S] = C.useState(null), [P, j] = C.useState(null), M = C.useCallback((X) => {
  ...
  }, []), $ = u || A, U = f || P, Z = C.useRef(null), q = C.useRef(null), oe = C.useRef(v), ge = p != null, de = Uf(p), be = Uf(a), ne = C.useCallback(() => {
    ...
    be.current && (X.platform = be.current), Zy(Z.current, q.current, X).then((D) => {
      const H = {
        ...D,
        isPositioned: !0
      };
  ...
  const ue = C.useMemo(() => ({
    ...
    if (!ke.floating)
      return X;
    const D = Ff(ke.floating, v.x), H = Ff(ke.floating, v.y);
    return h ? {
      ...X,
...
const t0 = (i) => {
  ...
  return {
    ...
    fn(r) {
      ...
      return s && n(s) ? s.current != null ? Mf({
        element: s.current,
        padding: a
      }).fn(r) : {} : s ? Mf({
        element: s,
...
var u0 = "Arrow", Vh = C.forwardRef((i, n) => {
...
var uu = "Popper", [Kh, Gh] = Rh(uu), [f0, Qh] = Kh(uu), qh = (i) => {
  const { __scopePopper: n, children: r } = i, [s, a] = C.useState(null);
  return /* @__PURE__ */ W.jsx(f0, { scope: n, anchor: s, onAnchorChange: a, children: r });
};
qh.displayName = uu;
var Jh = "PopperAnchor", Yh = C.forwardRef(
  (i, n) => {
    const { __scopePopper: r, virtualRef: s, ...a } = i, u = Qh(Jh, r), f = C.useRef(null), h = An(n, f);
    return C.useEffect(() => {
...
Yh.displayName = Jh;
var cu = "PopperContent", [h0, p0] = Kh(cu), Xh = C.forwardRef(
  (i, n) => {
    const {
      __scopePopper: r,
      side: s = "bottom",
      ...
      onPlaced: A,
      ...S
    } = i, P = Qh(cu, r), [j, M] = C.useState(null), B = An(n, (ye) => M(ye)), [$, U] = C.useState(null), Z = d0($), q = Z?.width ?? 0, oe = Z?.height ?? 0, ge = s + (u !== "center" ? "-" + u : ""), de = typeof v == "number" ? v : { top: 0, right: 0, bottom: 0, left: 0, ...v }, be = Array.isArray(g) ? g : [g], ne = be.length > 0, xe = {
      padding: de,
      boundary: be.filter(g0),
      // with `strategy: 'fixed'`, this is the only way to get it to respect boundaries
      altBoundary: ne
    }, { refs: ue, floatingStyles: ke, placement: he, isPositioned: X, middlewareData: D } = e0({
      // default to `fixed` strategy so users don't have to pick and we also avoid focus scroll issues
      strategy: "fixed",
      placement: ge,
      whileElementsMounted: (...ye) => Ky(...ye, {
      ...
      middleware: [
        n0({ mainAxis: a + oe, alignmentAxis: f }),
        p && r0({
          mainAxis: !0,
          crossAxis: !1,
          limiter: y === "partial" ? o0() : void 0,
          ...xe
        }),
        p && i0({ ...xe }),
        s0({
        ...
        $ && a0({ element: $, padding: h }),
        v0({ arrowWidth: q, arrowHeight: oe }),
        _ && l0({ strategy: "referenceHidden", ...xe })
      ]
    }), [H, V] = tp(he), E = Pn(A);
    Yn(() => {
      X && E?.();
...
Xh.displayName = cu;
var Zh = "PopperArrow", m0 = {
  top: "bottom",
  right: "left",
  bottom: "top",
  left: "right"
}, ep = C.forwardRef(function(n, r) {
  const { __scopePopper: s, ...a } = n, u = p0(Zh, s), f = m0[u.placedSide];
  return (
...
var v0 = (i) => ({
  ...
  options: i,
  fn(n) {
    const { placement: r, rects: s, middlewareData: a } = n, f = a.arrow?.centerOffset !== 0, h = f ? 0 : i.arrowWidth, p = f ? 0 : i.arrowHeight, [g, v] = tp(r), y = { start: "0%", center: "50%", end: "100%" }[v], _ = (a.arrow?.x ?? 0) + h / 2, b = (a.arrow?.y ?? 0) + p / 2;
    let A = "", S = "";
...
var y0 = qh, np = Yh, w0 = Xh, _0 = ep, x0 = "Portal", rp = C.forwardRef((i, n) => {
  const { container: r, ...s } = i, [a, u] = C.useState(!1);
  Yn(() => u(!0), []);
  const f = r || a && globalThis?.document?.body;
  return f ? Jg.createPortal(/* @__PURE__ */ W.jsx(At.div, { ...s, ref: n }), f) : null;
});
rp.displayName = x0;
function k0(i, n) {
...
var du = (i) => {
  const { present: n, children: r } = i, s = S0(n), a = typeof r == "function" ? r({ present: s.isPresent }) : C.Children.only(r), u = An(s.ref, b0(a));
  return typeof r == "function" || s.isPresent ? C.cloneElement(a, { ref: u }) : null;
};
du.displayName = "Presence";
function S0(i) {
  const [n, r] = C.useState(), s = C.useRef({}), a = C.useRef(i), u = C.useRef("none"), f = i ? "mounted" : "unmounted", [h, p] = k0(f, {
    mounted: {
      UNMOUNT: "unmounted",
...
function E0({
  ...
  const [s, a] = C0({ defaultProp: n, onChange: r }), u = i !== void 0, f = u ? i : s, h = Pn(r), p = C.useCallback(
    (g) => {
      if (u) {
...
var P0 = function(i) {
...
}, Cr = /* @__PURE__ */ new WeakMap(), os = /* @__PURE__ */ new WeakMap(), is = {}, Ra = 0, op = function(i) {
  return i && (i.host || op(i.parentNode));
}, T0 = function(i, n) {
  ...
  var a = T0(n, Array.isArray(i) ? i : [i]);
  ...
  return v(n), h.clear(), Ra++, function() {
    f.forEach(function(y) {
      var _ = Cr.get(y) - 1, b = u.get(y) - 1;
      Cr.set(y, _), u.set(y, b), _ || (os.has(y) || y.removeAttribute(s), os.delete(y)), b || y.removeAttribute(r);
    }), Ra--, Ra || (Cr = /* @__PURE__ */ new WeakMap(), Cr = /* @__PURE__ */ new WeakMap(), os = /* @__PURE__ */ new WeakMap(), is = {});
  };
}, R0 = function(i, n, r) {
  r === void 0 && (r = "data-aria-hidden");
  var s = Array.from(Array.isArray(i) ? i : [i]), a = n || P0(i);
  return a ? (s.push.apply(s, Array.from(a.querySelectorAll("[aria-live]"))), O0(s, a, r, "aria-hidden")) : function() {
    return null;
  };
}, Dt = function() {
...
var hs = "right-scroll-bar-position", ps = "width-before-scroll-bar", j0 = "with-scroll-bars-hidden", N0 = "--removed-body-scroll-bar-size";
function Aa(i, n) {
...
var I0 = typeof window < "u" ? C.useLayoutEffect : C.useEffect, Bf = /* @__PURE__ */ new WeakMap();
function $0(i, n) {
  var r = L0(n || null, function(s) {
...
var sp = function(i) {
  var n = i.sideCar, r = ip(i, ["sideCar"]);
  if (!n)
...
function F0(i, n) {
  return i.useMedium(n), sp;
}
var lp = M0(), ja = function() {
}, ks = C.forwardRef(function(i, n) {
  var r = C.useRef(null), s = C.useState({
    onScrollCapture: ja,
    onWheelCapture: ja,
    onTouchMoveCapture: ja
  }), a = s[0], u = s[1], f = i.forwardProps, h = i.children, p = i.className, g = i.removeScrollBar, v = i.enabled, y = i.shards, _ = i.sideCar, b = i.noIsolation, A = i.inert, S = i.allowPinchZoom, P = i.as, j = P === void 0 ? "div" : P, M = i.gapMode, B = ip(i, ["forwardProps", "children", "className", "removeScrollBar", "enabled", "shards", "sideCar", "noIsolation", "inert", "allowPinchZoom", "as", "gapMode"]), $ = _, U = $0([r, n]), Z = Dt(Dt({}, B), a);
  return C.createElement(
    C.Fragment,
    null,
    v && C.createElement($, { sideCar: lp, removeScrollBar: g, shards: y, noIsolation: b, inert: A, setCallbacks: u, allowPinchZoom: !!S, lockRef: r, gapMode: M }),
...
var V0 = function() {
  ...
  return [Na(r), Na(s), Na(a)];
}, q0 = function(i) {
  if (i === void 0 && (i = "margin"), typeof window > "u")
    return G0;
  var n = Q0(i), r = document.documentElement.clientWidth, s = window.innerWidth;
  return {
    left: n[0],
    top: n[1],
    right: n[2],
...
}, J0 = ap(), Nr = "data-scroll-locked", Y0 = function(i, n, r, s) {
...
`);
  ...
  C.useEffect(function() {
    return document.body.setAttribute(Nr, (Hf() + 1).toString()), function() {
      var i = Hf() - 1;
  ...
  return C.createElement(J0, { styles: Y0(u, !n, a, r ? "" : "!important") });
}, Qa = !1;
if (typeof window < "u")
  try {
...
var Pr = Qa ? { passive: !1 } : !1, ew = function(i) {
  ...
  return (
    ...
    !(r.overflowY === r.overflowX && !ew(i) && r[n] === "visible")
  );
}, tw = function(i) {
  return up(i, "overflowY");
}, nw = function(i) {
  return up(i, "overflowX");
}, Vf = function(i, n) {
  ...
  return i === "v" ? tw(n) : nw(n);
}, dp = function(i, n) {
  return i === "v" ? rw(n) : ow(n);
}, iw = function(i, n) {
  return i === "h" && n === "rtl" ? -1 : 1;
}, sw = function(i, n, r, s, a) {
  var u = iw(i, window.getComputedStyle(n).direction), f = u * s, h = r.target, p = n.contains(h), g = !1, v = f > 0, y = 0, _ = 0;
  do {
    var b = dp(i, h), A = b[0], S = b[1], P = b[2], j = S - P - u * A;
    (A || j) && cp(i, h) && (y += j, _ += A), h instanceof ShadowRoot ? h = h.host : h = h.parentNode;
  } while (
    // portaled content
...
function cw(i) {
  var n = C.useRef([]), r = C.useRef([0, 0]), s = C.useRef(), a = C.useState(uw++)[0], u = C.useState(ap)[0], f = C.useRef(i);
  C.useEffect(function() {
    f.current = i;
  }, [i]), C.useEffect(function() {
    if (i.inert) {
      document.body.classList.add("block-interactivity-".concat(a));
      var S = A0([i.lockRef.current], (i.shards || []).map(Gf), !0).filter(Boolean);
  ...
  var h = C.useCallback(function(S, P) {
    ...
    if (!oe)
      return !0;
    if (oe ? U = q : (U = q === "v" ? "h" : "v", oe = Vf(q, Z)), !oe)
      return !1;
    if (!s.current && "changedTouches" in S && (B || $) && (s.current = U), !U)
      return !0;
    var ge = s.current || U;
    return sw(ge, P, S, ge === "h" ? B : $, !0);
  }, []), p = C.useCallback(function(S) {
    var P = S;
    if (!(!Tr.length || Tr[Tr.length - 1] !== u)) {
      var j = "deltaY" in P ? Kf(P) : ls(P), M = n.current.filter(function(U) {
        return U.name === P.type && (U.target === P.target || P.target === U.shadowParent) && lw(U.delta, j);
      })[0];
      if (M && M.should) {
      ...
      if (!M) {
        var B = (f.current.shards || []).map(Gf).filter(Boolean).filter(function(U) {
    ...
    var B = { name: S, delta: P, target: j, should: M, shadowParent: dw(j) };
    ...
    g(S.type, Kf(S), S.target, h(S, i.lockRef.current));
  ...
  return C.createElement(
    C.Fragment,
    null,
    A ? C.createElement(u, { styles: aw(a) }) : null,
    b ? C.createElement(Z0, { gapMode: i.gapMode }) : null
  );
}
function dw(i) {
...
const fw = F0(lp, cw);
var fp = C.forwardRef(function(i, n) {
  return C.createElement(ks, Dt({}, i, { ref: n, sideCar: fw }));
});
fp.classNames = ks.classNames;
const hw = fp;
var fu = "Popover", [hp, I1] = Rh(fu, [
  Gh
]), Wo = Gh(), [pw, jn] = hp(fu), pp = (i) => {
  const {
    __scopePopover: n,
    children: r,
    open: s,
    ...
    onOpenChange: u,
    modal: f = !1
  } = i, h = Wo(n), p = C.useRef(null), [g, v] = C.useState(!1), [y = !1, _] = E0({
    prop: s,
    defaultProp: a,
    onChange: u
  });
  return /* @__PURE__ */ W.jsx(y0, { ...h, children: /* @__PURE__ */ W.jsx(
    pw,
    {
      scope: n,
      contentId: dy(),
...
pp.displayName = fu;
var mp = "PopoverAnchor", mw = C.forwardRef(
  (i, n) => {
    const { __scopePopover: r, ...s } = i, a = jn(mp, r), u = Wo(r), { onCustomAnchorAdd: f, onCustomAnchorRemove: h } = a;
    return C.useEffect(() => (f(), () => h()), [f, h]), /* @__PURE__ */ W.jsx(np, { ...u, ...s, ref: n });
  }
);
mw.displayName = mp;
var gp = "PopoverTrigger", vp = C.forwardRef(
  (i, n) => {
    const { __scopePopover: r, ...s } = i, a = jn(gp, r), u = Wo(r), f = An(n, a.triggerRef), h = /* @__PURE__ */ W.jsx(
      At.button,
      {
        type: "button",
        ...
        "data-state": kp(a.open),
        ...s,
        ref: f,
        onClick: Cn(i.onClick, a.onOpenToggle)
      }
    );
    return a.hasCustomAnchor ? h : /* @__PURE__ */ W.jsx(np, { asChild: !0, ...u, children: h });
  }
);
vp.displayName = gp;
var hu = "PopoverPortal", [gw, vw] = hp(hu, {
  forceMount: void 0
}), yp = (i) => {
  const { __scopePopover: n, forceMount: r, children: s, container: a } = i, u = jn(hu, n);
  return /* @__PURE__ */ W.jsx(gw, { scope: n, forceMount: r, children: /* @__PURE__ */ W.jsx(du, { present: r || u.open, children: /* @__PURE__ */ W.jsx(rp, { asChild: !0, container: a, children: s }) }) });
};
yp.displayName = hu;
var $r = "PopoverContent", wp = C.forwardRef(
  (i, n) => {
    const r = vw($r, i.__scopePopover), { forceMount: s = r.forceMount, ...a } = i, u = jn($r, i.__scopePopover);
    return /* @__PURE__ */ W.jsx(du, { present: s || u.open, children: u.modal ? /* @__PURE__ */ W.jsx(yw, { ...a, ref: n }) : /* @__PURE__ */ W.jsx(ww, { ...a, ref: n }) });
  }
);
wp.displayName = $r;
var yw = C.forwardRef(
  (i, n) => {
    ...
    return C.useEffect(() => {
      ...
      if (f)
        return R0(f);
    }, []), /* @__PURE__ */ W.jsx(hw, { as: ws, allowPinchZoom: !0, children: /* @__PURE__ */ W.jsx(
      _p,
      {
        ...i,
        ref: a,
...
), xp = "PopoverClose", _w = C.forwardRef(
  (i, n) => {
    const { __scopePopover: r, ...s } = i, a = jn(xp, r);
    return /* @__PURE__ */ W.jsx(
      At.button,
      {
        type: "button",
...
_w.displayName = xp;
var xw = "PopoverArrow", kw = C.forwardRef(
  (i, n) => {
    const { __scopePopover: r, ...s } = i, a = Wo(r);
    return /* @__PURE__ */ W.jsx(_0, { ...a, ...s, ref: n });
  }
);
kw.displayName = xw;
function kp(i) {
...
var Sw = pp, bw = vp, Ew = yp, Sp = wp;
const Cw = Sw, Pw = bw, bp = C.forwardRef(({ className: i, align: n = "center", sideOffset: r = 4, ...s }, a) => /* @__PURE__ */ W.jsx(Ew, { children: /* @__PURE__ */ W.jsx(
  Sp,
  {
    ref: a,
    align: n,
...
var jw = globalThis && globalThis.__awaiter || function(i, n, r, s) {
  function a(u) {
...
class Nw {
  constructor(n, { headers: r = {}, customFetch: s, region: a = qa.Any } = {}) {
    this.url = n, this.headers = r, this.region = a, this.fetch = Tw(s);
  }
  /**
...
var wt = {}, mu = {}, Ss = {}, Ho = {}, bs = {}, Es = {}, Lw = function() {
  if (typeof self < "u")
    return self;
  if (typeof window < "u")
    return window;
...
const Iw = Dr.fetch, Ep = Dr.fetch.bind(Dr), Cp = Dr.Headers, $w = Dr.Request, Dw = Dr.Response, Br = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  Headers: Cp,
  Request: $w,
  Response: Dw,
  default: Ep,
  fetch: Iw
}, Symbol.toStringTag, { value: "Module" })), zw = /* @__PURE__ */ Hg(Br);
var gu = {};
...
gu.default = Mw;
var Pp = _t && _t.__importDefault || function(i) {
  return i && i.__esModule ? i : { default: i };
};
Object.defineProperty(Es, "__esModule", { value: !0 });
const Fw = Pp(zw), Uw = Pp(gu);
let Bw = class {
  constructor(n) {
    this.shouldThrowOnError = !1, this.method = n.method, this.url = n.url, this.headers = n.headers, this.schema = n.schema, this.body = n.body, this.shouldThrowOnError = n.shouldThrowOnError, this.signal = n.signal, this.isMaybeSingle = n.isMaybeSingle, n.fetch ? this.fetch = n.fetch : typeof fetch > "u" ? this.fetch = Fw.default : this.fetch = fetch;
  }
  /**
...
Es.default = Bw;
var Ww = _t && _t.__importDefault || function(i) {
  return i && i.__esModule ? i : { default: i };
};
Object.defineProperty(bs, "__esModule", { value: !0 });
const Hw = Ww(Es);
let Vw = class extends Hw.default {
  /**
...
bs.default = Vw;
var Kw = _t && _t.__importDefault || function(i) {
  return i && i.__esModule ? i : { default: i };
};
Object.defineProperty(Ho, "__esModule", { value: !0 });
const Gw = Kw(bs);
let Qw = class extends Gw.default {
  /**
...
Ho.default = Qw;
var qw = _t && _t.__importDefault || function(i) {
  return i && i.__esModule ? i : { default: i };
};
...
const Yw = Ps;
Cs.DEFAULT_HEADERS = { "X-Client-Info": `postgrest-js/${Yw.version}` };
var Tp = _t && _t.__importDefault || function(i) {
  return i && i.__esModule ? i : { default: i };
};
Object.defineProperty(mu, "__esModule", { value: !0 });
const Xw = Tp(Ss), Zw = Tp(Ho), e_ = Cs;
let t_ = class Op {
   ...
   */
  constructor(n, { headers: r = {}, schema: s, fetch: a } = {}) {
    this.url = n, this.headers = Object.assign(Object.assign({}, e_.DEFAULT_HEADERS), r), this.schemaName = s, this.fetch = a;
  }
  /**
  ...
  rpc(n, r = {}, { head: s = !1, get: a = !1, count: u } = {}) {
    ...
    return u && (g.Prefer = `count=${u}`), new Zw.default({
      method: f,
      url: h,
      headers: g,
      schema: this.schemaName,
...
const Rp = Vo(mu);
wt.PostgrestClient = Rp.default;
const Ap = Vo(Ss);
wt.PostgrestQueryBuilder = Ap.default;
const jp = Vo(Ho);
wt.PostgrestFilterBuilder = jp.default;
const Np = Vo(bs);
wt.PostgrestTransformBuilder = Np.default;
const Lp = Vo(Es);
wt.PostgrestBuilder = Lp.default;
var n_ = wt.default = {
  PostgrestClient: Rp.default,
  PostgrestQueryBuilder: Ap.default,
  PostgrestFilterBuilder: jp.default,
  PostgrestTransformBuilder: Np.default,
  PostgrestBuilder: Lp.default
};
const {
  PostgrestClient: r_,
  PostgrestQueryBuilder: F1,
  PostgrestFilterBuilder: U1,
  PostgrestTransformBuilder: B1,
  PostgrestBuilder: W1
} = n_, o_ = "2.10.2", i_ = { "X-Client-Info": `realtime-js/${o_}` }, s_ = "1.0.0", Ip = 1e4, l_ = 1e3;
var Lr;
(function(i) {
...
const qf = (i, n, r = {}) => {
  ...
  return Object.keys(n).reduce((u, f) => (u[f] = u_(f, i, n, a), u), {});
}, u_ = (i, n, r, s) => {
  const a = n.find((h) => h.name === i), u = a?.type, f = r[i];
  return u && !s.includes(u) ? Dp(u, f) : Ya(f);
}, Dp = (i, n) => {
  if (i.charAt(0) === "_") {
  ...
  if (i[0] === "{" && s === "}") {
    ...
    return u.map((h) => Dp(n, h));
  }
  return i;
}, p_ = (i) => typeof i == "string" ? i.replace(" ", "T") : i, zp = (i) => {
  let n = i;
...
class vu {
  constructor(n, r = { config: {} }, s) {
    this.topic = n, this.params = r, this.socket = s, this.bindings = {}, this.state = ut.closed, this.joinedOnce = !1, this.pushBuffer = [], this.subTopic = n.replace(/^realtime:/i, ""), this.params.config = Object.assign({
      ...
      presence: { key: "" },
      private: !1
    }, r.config), this.timeout = this.socket.timeout, this.joinPush = new La(this, Ot.join, this.params, this.timeout), this.rejoinTimer = new $p(() => this._rejoinUntilConnected(), this.socket.reconnectAfterMs), this.joinPush.receive("ok", () => {
    ...
    }), this.presence = new $o(this), this.broadcastEndpointURL = zp(this.socket.endPoint) + "/api/broadcast";
  }
  ...
  unsubscribe(n = this.timeout) {
    ...
    return this.rejoinTimer.reset(), this.joinPush.destroy(), new Promise((s) => {
      const a = new La(this, Ot.leave, {}, n);
      a.receive("ok", () => {
        r(), s("ok");
      }).receive("timeout", () => {
        r(), s("timed out");
  ...
  _off(n, r) {
    ...
    return this.bindings[s] = this.bindings[s].filter((a) => {
      var u;
      return !(((u = a.type) === null || u === void 0 ? void 0 : u.toLocaleLowerCase()) === s && vu.isEqual(a.filter, r));
    }), this;
  }
  /** @internal */
  static isEqual(n, r) {
  ...
  _getPayloadRecords(n) {
    ...
    return (n.type === "INSERT" || n.type === "UPDATE") && (r.new = qf(n.columns, n.record)), (n.type === "UPDATE" || n.type === "DELETE") && (r.old = qf(n.columns, n.old_record)), r;
  }
}
const m_ = () => {
}, g_ = typeof WebSocket < "u";
class v_ {
  /**
  ...
  constructor(n, r) {
    var s;
    this.accessToken = null, this.apiKey = null, this.channels = [], this.endPoint = "", this.httpEndpoint = "", this.headers = i_, this.params = {}, this.timeout = Ip, this.heartbeatIntervalMs = 3e4, this.heartbeatTimer = void 0, this.pendingHeartbeatRef = null, this.ref = 0, this.logger = m_, this.conn = null, this.sendBuffer = [], this.serializer = new a_(), this.stateChangeCallbacks = {
      open: [],
      close: [],
      error: [],
      message: []
    ...
    }, this.endPoint = `${n}/${Ja.websocket}`, this.httpEndpoint = zp(n), r?.transport ? this.transport = r.transport : this.transport = null, r?.params && (this.params = r.params), r?.headers && (this.headers = Object.assign(Object.assign({}, this.headers), r.headers)), r?.timeout && (this.timeout = r.timeout), r?.logger && (this.logger = r.logger), r?.heartbeatIntervalMs && (this.heartbeatIntervalMs = r.heartbeatIntervalMs);
    const a = (s = r?.params) === null || s === void 0 ? void 0 : s.apikey;
    a && (this.accessToken = a, this.apiKey = a), this.reconnectAfterMs = r?.reconnectAfterMs ? r.reconnectAfterMs : (u) => [1e3, 2e3, 5e3, 1e4][u - 1] || 1e4, this.encode = r?.encode ? r.encode : (u, f) => f(JSON.stringify(u)), this.decode = r?.decode ? r.decode : this.serializer.decode.bind(this.serializer), this.reconnectTimer = new $p(async () => {
  ...
  connect() {
    if (!this.conn) {
      ...
      this.conn = new y_(this._endPointURL(), void 0, {
        close: () => {
          this.conn = null;
        }
      }), import("./browser-7723b206.js").then((n) => n.b).then(({ default: n }) => {
  ...
  channel(n, r = { config: {} }) {
    const s = new vu(`realtime:${n}`, r, this);
   ...
   */
  _endPointURL() {
    return this._appendParams(this.endPoint, Object.assign({}, this.params, { vsn: s_ }));
  }
  /** @internal */
  _onConnMessage(n) {
  ...
  _sendHeartbeat() {
    ...
    if (this.isConnected()) {
      if (this.pendingHeartbeatRef) {
        this.pendingHeartbeatRef = null, this.log("transport", "heartbeat timeout. Attempting to re-establish connection"), (n = this.conn) === null || n === void 0 || n.close(l_, "hearbeat timeout");
        return;
      }
...
var __ = globalThis && globalThis.__awaiter || function(i, n, r, s) {
  function a(u) {
    return u instanceof r ? u : new r(function(f) {
      f(u);
    });
...
const Mp = (i) => {
  let n;
  return i ? n = i : typeof fetch > "u" ? n = (...r) => Promise.resolve().then(() => Br).then(({ default: s }) => s(...r)) : n = fetch, (...r) => n(...r);
}, x_ = () => __(void 0, void 0, void 0, function* () {
...
const Ia = (i) => i.msg || i.message || i.error_description || i.error || JSON.stringify(i), k_ = (i, n) => Wr(void 0, void 0, void 0, function* () {
  const r = yield x_();
  i instanceof r ? i.json().then((s) => {
    n(new w_(Ia(s), i.status || 500));
  }).catch((s) => {
    n(new eh(Ia(s), s));
  }) : n(new eh(Ia(i), i));
}), S_ = (i, n, r, s) => {
...
function Ts(i, n, r, s, a, u) {
  return Wr(this, void 0, void 0, function* () {
    return new Promise((f, h) => {
      i(r, S_(n, s, a, u)).then((p) => {
        if (!p.ok)
          throw p;
        return s?.noResolveJson ? p : p.json();
      }).then((p) => f(p)).catch((p) => k_(p, h));
    });
  });
}
function Xa(i, n, r, s) {
...
function b_(i, n, r, s, a) {
  return Wr(this, void 0, void 0, function* () {
    return Ts(i, "PUT", n, s, a, r);
  });
}
function Fp(i, n, r, s, a) {
  return Wr(this, void 0, void 0, function* () {
...
class C_ {
  constructor(n, r = {}, s, a) {
    this.url = n, this.headers = r, this.bucketId = s, this.fetch = Mp(a);
  }
  /**
  ...
  uploadOrUpdate(n, r, s, a) {
    return yt(this, void 0, void 0, function* () {
      try {
        let u;
        const f = Object.assign(Object.assign({}, th), a), h = Object.assign(Object.assign({}, this.headers), n === "POST" && { "x-upsert": String(f.upsert) });
  ...
  uploadToSignedUrl(n, r, s, a) {
    return yt(this, void 0, void 0, function* () {
      ...
      try {
        let p;
        const g = Object.assign({ upsert: th.upsert }, a), v = Object.assign(Object.assign({}, this.headers), { "x-upsert": String(g.upsert) });
  ...
  createSignedUploadUrl(n, r) {
    return yt(this, void 0, void 0, function* () {
      try {
        ...
        if (!h)
          throw new yu("No token returned by API");
  ...
  download(n, r) {
    return yt(this, void 0, void 0, function* () {
      ...
      try {
        ...
        return { data: yield (yield Xa(this.fetch, `${this.url}/${a}/${h}${f}`, {
          headers: this.headers,
          noResolveJson: !0
        })).blob(), error: null };
      } catch (h) {
  ...
  remove(n) {
    return yt(this, void 0, void 0, function* () {
      try {
        return { data: yield Fp(this.fetch, `${this.url}/object/${this.bucketId}`, { prefixes: n }, { headers: this.headers }), error: null };
      } catch (r) {
        if (qe(r))
  ...
  list(n, r, s) {
    return yt(this, void 0, void 0, function* () {
      try {
        const a = Object.assign(Object.assign(Object.assign({}, E_), r), { prefix: n || "" });
...
const P_ = "2.6.0", T_ = { "X-Client-Info": `storage-js/${P_}` };
...
class O_ {
  constructor(n, r = {}, s) {
    this.url = n, this.headers = Object.assign(Object.assign({}, T_), r), this.fetch = Mp(s);
  }
  /**
  ...
  listBuckets() {
    return Or(this, void 0, void 0, function* () {
      try {
        return { data: yield Xa(this.fetch, `${this.url}/bucket`, { headers: this.headers }), error: null };
      } catch (n) {
        if (qe(n))
  ...
  getBucket(n) {
    return Or(this, void 0, void 0, function* () {
      try {
        return { data: yield Xa(this.fetch, `${this.url}/bucket/${n}`, { headers: this.headers }), error: null };
      } catch (r) {
        if (qe(r))
          return { data: null, error: r };
        throw r;
  ...
  updateBucket(n, r) {
    return Or(this, void 0, void 0, function* () {
      try {
        return { data: yield b_(this.fetch, `${this.url}/bucket/${n}`, {
          id: n,
          name: n,
          public: r.public,
          file_size_limit: r.fileSizeLimit,
  ...
  deleteBucket(n) {
    return Or(this, void 0, void 0, function* () {
      try {
        return { data: yield Fp(this.fetch, `${this.url}/bucket/${n}`, {}, { headers: this.headers }), error: null };
      } catch (r) {
        if (qe(r))
          return { data: null, error: r };
        throw r;
...
var D_ = globalThis && globalThis.__awaiter || function(i, n, r, s) {
  function a(u) {
    return u instanceof r ? u : new r(function(f) {
      f(u);
    });
...
const z_ = (i) => {
  let n;
  return i ? n = i : typeof fetch > "u" ? n = Ep : n = fetch, (...r) => n(...r);
}, M_ = () => typeof Headers > "u" ? Cp : Headers, F_ = (i, n, r) => {
  const s = z_(r), a = M_();
  return (u, f) => D_(void 0, void 0, void 0, function* () {
    var h;
...
const Up = "2.64.4", W_ = "http://localhost:9999", H_ = "supabase.auth.token", V_ = { "X-Client-Info": `gotrue-js/${Up}` }, nh = 10, Za = "X-Supabase-Api-Version", Bp = {
  "2024-01-01": {
...
const Wp = (i) => {
  let n;
  return i ? n = i : typeof fetch > "u" ? n = (...r) => Promise.resolve().then(() => Br).then(({ default: s }) => s(...r)) : n = fetch, (...r) => n(...r);
}, Q_ = (i) => typeof i == "object" && i !== null && "status" in i && "ok" in i && "json" in i && typeof i.json == "function", Hp = async (i, n, r) => {
...
function Z_() {
  ...
  return crypto.getRandomValues(n), Array.from(n, X_).join("");
}
async function e1(i) {
...
async function Rr(i, n, r = !1) {
  const s = Z_();
  let a = s;
  r && (a += "/PASSWORD_RECOVERY"), await Hp(i, `${n}-code-verifier`, a);
  const u = await n1(s);
  return [u, s === u ? "plain" : "s256"];
}
const r1 = /^2[0-9]{3}-(0[1-9]|1[0-2])-(0[1-9]|1[0-9]|2[0-9]|3[0-1])$/i;
function o1(i) {
  const n = i.headers.get(Za);
  if (!n || !n.match(r1))
    return null;
  try {
...
var l1 = globalThis && globalThis.__rest || function(i, n) {
  var r = {};
  for (var s in i)
    Object.prototype.hasOwnProperty.call(i, s) && n.indexOf(s) < 0 && (r[s] = i[s]);
  if (i != null && typeof Object.getOwnPropertySymbols == "function")
...
const Qn = (i) => i.msg || i.message || i.error_description || i.error || JSON.stringify(i), a1 = [502, 503, 504];
async function sh(i) {
  var n;
  if (!Q_(i))
    throw new eu(Qn(i), 0);
  if (a1.includes(i.status))
    throw new eu(Qn(i), i.status);
  let r;
  try {
    r = await i.json();
  } catch (u) {
  ...
  let s;
  const a = o1(i);
  if (a && a.getTime() >= Bp["2024-01-01"].timestamp && typeof r == "object" && r && typeof r.code == "string" ? s = r.code : typeof r == "object" && r && typeof r.error_code == "string" && (s = r.error_code), s) {
    if (s === "weak_password")
      throw new ih(Qn(r), i.status, ((n = r.weak_password) === null || n === void 0 ? void 0 : n.reasons) || []);
    ...
    throw new ih(Qn(r), i.status, r.weak_password.reasons);
  throw new i1(Qn(r), i.status || 500, s);
}
const u1 = (i, n, r, s) => {
  const a = { method: i, headers: n?.headers || {} };
...
async function fe(i, n, r, s) {
  ...
  u[Za] || (u[Za] = Bp["2024-01-01"].name), s?.jwt && (u.Authorization = `Bearer ${s.jwt}`);
  const f = (a = s?.query) !== null && a !== void 0 ? a : {};
  s?.redirectTo && (f.redirect_to = s.redirectTo);
  const h = Object.keys(f).length ? "?" + new URLSearchParams(f).toString() : "", p = await c1(i, n, r + h, {
    headers: u,
    noResolveJson: s?.noResolveJson
  }, {}, s?.body);
  return s?.xform ? s?.xform(p) : { data: Object.assign({}, p), error: null };
}
async function c1(i, n, r, s, a, u) {
  const f = u1(n, s, a, u);
  let h;
  try {
    h = await i(r, Object.assign({}, f));
  } catch (p) {
    throw console.error(p), new eu(Qn(p), 0);
  }
  if (h.ok || await sh(h), s?.noResolveJson)
    return h;
  try {
    return await h.json();
  } catch (p) {
...
function Sn(i) {
  var n;
  let r = null;
  p1(i) && (r = Object.assign({}, i), i.expires_at || (r.expires_at = K_(i.expires_in)));
...
function f1(i) {
  const { action_link: n, email_otp: r, hashed_token: s, redirect_to: a, verification_type: u } = i, f = l1(i, ["action_link", "email_otp", "hashed_token", "redirect_to", "verification_type"]), h = {
    action_link: n,
    email_otp: r,
    hashed_token: s,
    redirect_to: a,
...
var m1 = globalThis && globalThis.__rest || function(i, n) {
  var r = {};
  for (var s in i)
    Object.prototype.hasOwnProperty.call(i, s) && n.indexOf(s) < 0 && (r[s] = i[s]);
  if (i != null && typeof Object.getOwnPropertySymbols == "function")
...
class g1 {
  constructor({ url: n = "", headers: r = {}, fetch: s }) {
    this.url = n, this.headers = r, this.fetch = Wp(s), this.mfa = {
  ...
  async generateLink(n) {
    try {
      const { options: r } = n, s = m1(n, ["options"]), a = Object.assign(Object.assign({}, s), r);
...
async function _1(i, n, r) {
  ...
  return n > 0 && setTimeout(() => {
    ...
    if (a) {
      ...
      if (n === 0)
        throw Ar.debug && console.log("@supabase/gotrue-js: navigatorLock: not immediately available", i), new w1(`Acquiring an exclusive Navigator LockManager lock "${i}" immediately failed`);
      if (Ar.debug)
        try {
...
class Fo {
  ...
  constructor(n) {
    ...
    const a = Object.assign(Object.assign({}, x1), n);
    if (this.logDebugMessages = !!a.debug, typeof a.debug == "function" && (this.logger = a.debug), this.persistSession = a.persistSession, this.storageKey = a.storageKey, this.autoRefreshToken = a.autoRefreshToken, this.admin = new g1({
      url: a.url,
      headers: a.headers,
      fetch: a.fetch
    }), this.url = a.url, this.headers = a.headers, this.fetch = Wp(a.fetch), this.lock = a.lock || ch, this.detectSessionInUrl = a.detectSessionInUrl, this.flowType = a.flowType, this.hasCustomAuthorizationHeader = a.hasCustomAuthorizationHeader, a.lock ? this.lock = a.lock : Tt() && (!((r = globalThis?.navigator) === null || r === void 0) && r.locks) ? this.lock = _1 : this.lock = ch, this.mfa = {
    ...
    }, this.persistSession ? a.storage ? this.storage = a.storage : Do() ? this.storage = v1 : (this.memoryStorage = {}, this.storage = ah(this.memoryStorage)) : (this.memoryStorage = {}, this.storage = ah(this.memoryStorage)), Tt() && globalThis.BroadcastChannel && this.persistSession && this.storageKey) {
      try {
  ...
  _debug(...n) {
    return this.logDebugMessages && this.logger(`GoTrueClient@${this.instanceID} (${Up}) ${(/* @__PURE__ */ new Date()).toISOString()}`, ...n), this;
  }
  /**
  ...
  async _initialize() {
    try {
      ...
      return ce(n) ? { error: n } : {
        error: new Vp("Unexpected error during initialization", n)
      };
    } finally {
  ...
  async signInWithPassword(n) {
    try {
      ...
      return a ? { data: { user: null, session: null }, error: a } : !s || !s.session || !s.user ? { data: { user: null, session: null }, error: new za() } : (s.session && (await this._saveSession(s.session), await this._notifyAllSubscribers("SIGNED_IN", s.session)), {
  ...
  async _exchangeCodeForSession(n) {
    ...
    return await Da(this.storage, `${this.storageKey}-code-verifier`), f ? { data: { user: null, session: null, redirectType: null }, error: f } : !u || !u.session || !u.user ? {
  ...
  async _getSessionFromURL(n) {
    try {
      ...
      const r = $a(window.location.href);
      if (n) {
        if (!r.code)
          throw new oh("No code detected.");
  ...
  _isImplicitGrantFlow() {
    const n = $a(window.location.href);
   ...
   */
  async _isPKCEFlow() {
    const n = $a(window.location.href), r = await as(this.storage, `${this.storageKey}-code-verifier`);
    return !!(n.code && r);
  }
  /**
  ...
  async _signOut({ scope: n } = { scope: "global" }) {
    return await this._useSession(async (r) => {
      ...
      if (f) {
        ...
        if (h && !(s1(h) && (h.status === 404 || h.status === 401 || h.status === 403)))
          return { error: h };
      }
      return n !== "others" && (await this._removeSession(), await Da(this.storage, `${this.storageKey}-code-verifier`), await this._notifyAllSubscribers("SIGNED_OUT", null)), { error: null };
    });
  }
  /**
  ...
  async _refreshAccessToken(n) {
    ...
    try {
      const s = Date.now();
      return await Y_(async (a) => (a > 0 && await J_(200 * Math.pow(2, a - 1)), this._debug(r, "refreshing attempt", a), await fe(this.fetch, "POST", `${this.url}/token?grant_type=refresh_token`, {
        body: { refresh_token: n },
        headers: this.headers,
        xform: Sn
      })), (a, u) => {
        const f = 200 * Math.pow(2, a);
        return u && Ma(u) && // retryable only if the request can be sent before the backoff overflows the tick duration
        Date.now() + f - s < Lo;
      });
    } catch (s) {
  ...
  async _recoverAndRefresh() {
    ...
    try {
      ...
      const a = Math.round(Date.now() / 1e3), u = ((n = s.expires_at) !== null && n !== void 0 ? n : 1 / 0) < a + nh;
      if (this._debug(r, `session has${u ? "" : " not"} expired with margin of ${nh}s`), u) {
        if (this.autoRefreshToken && s.refresh_token) {
          const { error: f } = await this._callRefreshToken(s.refresh_token);
          f && (console.error(f), Ma(f) || (this._debug(r, "refresh failed with a non-retryable error, removing the session", f), await this._removeSession()));
        }
      } else
  ...
  async _callRefreshToken(n) {
    ...
    try {
      ...
      if (this._debug(a, "error", u), ce(u)) {
        ...
        return Ma(u) || (await this._removeSession(), await this._notifyAllSubscribers("SIGNED_OUT", null)), (r = this.refreshingDeferred) === null || r === void 0 || r.resolve(f), f;
      }
  ...
  async _saveSession(n) {
    this._debug("#_saveSession()", n), this.suppressGetSessionWarning = !0, await Hp(this.storage, this.storageKey, n);
  }
  async _removeSession() {
    this._debug("#_removeSession()"), await Da(this.storage, this.storageKey);
  }
  /**
  ...
  async _autoRefreshTokenTick() {
    ...
    try {
        ...
        try {
          ...
          try {
            return await this._useSession(async (r) => {
              ...
              this._debug("#_autoRefreshTokenTick()", `access token expires in ${a} ticks, a tick lasts ${Lo}ms, refresh threshold is ${uh} ticks`), a <= uh && await this._callRefreshToken(s.refresh_token);
            });
          } catch (r) {
      ...
      if (n.isAcquireTimeout || n instanceof Kp)
...
var b1 = globalThis && globalThis.__awaiter || function(i, n, r, s) {
  function a(u) {
    return u instanceof r ? u : new r(function(f) {
      f(u);
    });
...
class E1 {
  ...
  constructor(n, r, s) {
    ...
    const p = `sb-${new URL(this.authUrl).hostname.split(".")[0]}-auth-token`, g = {
      db: L_,
      realtime: $_,
      auth: Object.assign(Object.assign({}, I_), { storageKey: p }),
      global: N_
    }, v = B_(s ?? {}, g);
    this.storageKey = (a = v.auth.storageKey) !== null && a !== void 0 ? a : "", this.headers = (u = v.global.headers) !== null && u !== void 0 ? u : {}, this.auth = this._initSupabaseAuthClient((f = v.auth) !== null && f !== void 0 ? f : {}, this.headers, v.global.fetch), this.fetch = F_(r, this._getAccessToken.bind(this), v.global.fetch), this.realtime = this._initRealtimeClient(Object.assign({ headers: this.headers }, v.realtime)), this.rest = new r_(`${h}/rest/v1`, {
      headers: this.headers,
      schema: v.db.schema,
      fetch: this.fetch
   ...
   */
  get functions() {
    return new Nw(this.functionsUrl, {
      headers: this.headers,
   ...
   */
  get storage() {
    return new R_(this.storageUrl, this.headers, this.fetch);
  }
  /**
   * Perform a query on a table or a view.
   *
  ...
  _initRealtimeClient(n) {
    return new v_(this.realtimeUrl, Object.assign(Object.assign({}, n), { params: Object.assign({ apikey: this.supabaseKey }, n?.params) }));
  }
...
const C1 = (i, n, r) => new E1(i, n, r), P1 = "https://oqunzmnmzqiwtgmmvaxt.supabase.co", T1 = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9xdW56bW5tenFpd3RnbW12YXh0Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Mjk2MjAzNTUsImV4cCI6MjA0NTE5NjM1NX0.bkekFqwEbEf31CKloQrhhA2mmm9unu8oyqLh0t294iA", O1 = C1(P1, T1), R1 = ({ projectId: i }) => {
  const [n, r] = C.useState(3), [s, a] = C.useState(!1), u = (h) => {
    ...
    const p = h.target, g = {
      ...
      p_rating: n
    }, { data: v, error: y } = await O1.rpc("add_feedback", g);
    a(!0), console.log(v);
  };
  return /* @__PURE__ */ W.jsxs(W.Fragment, { children: [
    /* @__PURE__ */ W.jsx("style", { children: Qf }),
    /* @__PURE__ */ W.jsx("div", { className: "widget fixed bottom-4 right-4 z-50", children: /* @__PURE__ */ W.jsxs(Cw, { children: [
      /* @__PURE__ */ W.jsx(Pw, { asChild: !0, children: /* @__PURE__ */ W.jsxs(Wa, { className: "rounded-full shadow-lg hover:scale-105", children: [
        /* @__PURE__ */ W.jsx(j1, { className: "mr-2 h-5 w-5" }),
        "Feedback"
      ] }) }),
      /* @__PURE__ */ W.jsxs(bp, { className: "widget rounded-lg bg-card p-4 shadpw-lg w-full max-w-md", children: [
        /* @__PURE__ */ W.jsx("style", { children: Qf }),
            ...
            "form",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ W.jsxs("div", { className: "flex items-center justify-between", children: [
                  ...
                  /* @__PURE__ */ W.jsx(Wa, { type: "submit", children: "Submit" })
                ] })
              ]
            }
          )
        ] }),
        /* @__PURE__ */ W.jsx(Oh, { className: "my-4" }),
        /* @__PURE__ */ W.jsxs("div", { className: "text-gray-600", children: [
          "Powered by",
          " ",
          /* @__PURE__ */ W.jsx(
            "a",
...
const N1 = (i) => i.replace(/-([a-z])/g, (n, r) => r.toUpperCase());
class L1 extends HTMLElement {
  ...
  connectedCallback() {
    ...
    Fa.createRoot(this.shadowRoot).render(/* @__PURE__ */ W.jsx(R1, { ...n }));
  }
...
customElements.define("my-widget", L1);
export {
  dh as g
};
